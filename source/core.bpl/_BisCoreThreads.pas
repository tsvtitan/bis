...
procedure TBisCheckThread.Work;
var
  ADate: TDateTime;
  T: TDateTime;
begin
...
procedure TBisUpdateThread.Work;
begin
  inherited Work;
...
procedure TBisGetServerDateThread.Work;
begin
  inherited Work;
end;
...
procedure TBisSaveProfileThread.Work;
begin
  inherited Work;
...
procedure TBisLoadMenusThread.Work;
begin
  inherited Work;
...
procedure TBisLoadTasksThread.Work;
begin
  inherited Work;
...
procedure TBisSaveTaskThread.Work;
begin
  inherited Work;
...
procedure TBisLoadAlarmsThread.Work;
begin
  inherited Work;
...
procedure TBisLoadDocumentThread.Work;
begin
  inherited Work;
...
procedure TBisLoadReportThread.Work;
begin
  inherited Work;
  if (Return.Result<>trNeedLogin) and Core.LoginIface.Logged and Assigned(FStream) then begin
...
procedure TBisLoadScriptThread.Work;
begin
  inherited Work;
  if (Return.Result<>trNeedLogin) and Core.LoginIface.Logged and Assigned(FStream) then begin
...
procedure TBisExecuteThread.Work;
var
...
procedure TBisGetRecordsThread.Work;
var
  Provider: TBisProvider;
begin
  Provider:=nil;
...
procedure TBisCancelThread.Work;
begin
  inherited Work;
  if (Return.Result<>trNeedLogin) and Core.LoginIface.Logged then begin
