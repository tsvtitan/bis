...
{ TCustomSQLCommandEh }
  ...
  TDataDriverAssignParamEhEvent = procedure (DataDriver: TCustomSQLDataDriverEh;
    Command: TCustomSQLCommandEh; MemRecord: TMemoryRecordEh;
...
{ TBaseSQLDataDriverEh }
  ...
  private
    FOnAssignCommandParam: TDataDriverAssignParamEhEvent;
  ...
  public
    ...
    property OnAssignCommandParam: TDataDriverAssignParamEhEvent read FOnAssignCommandParam write FOnAssignCommandParam;
...
begin
  ...
  try
    ...
    if Command.DataDriver.DynaSQLParams.SkipUnchangedFields then
    begin
