...
type
  TBisMessDataOutMessageRecipientInfo=class(TObject)
  private                                                                                           
    FAccountId: Variant;
    FIsRole: Boolean;
    FSurname: String;
  ...
  public
    ...
    function AddRecipient(UserName, Surname, Name, Patronymic, Phone: String;
                          AccountId: Variant; IsRole: Boolean): TBisMessDataOutMessageRecipientInfo;
...
uses DateUtils,
     BisUtils, BisCore, BisFilterGroups, BisConsts, BisMessConsts, BisParamEditDataSelect,
     BisDataSet, BisProvider, BisParams, BisDialogs,
     BisDesignDataRolesAndAccountsFm, BisMessDataPatternMessagesFm,
     BisMessDataOutMessageEditFm;
...
procedure TBisMessDataOutMessageInsertExForm.CheckBoxOffsetClick(Sender: TObject);
begin
...
procedure TBisMessDataOutMessageInsertExForm.Execute;
  ...
  var
    Params: TBisParams;
    Obj: TBisMessDataOutMessageRecipientInfo;
    i: Integer;
  ...
  begin
    ...
    try
      ...
      for i:=0 to ListBoxRecipients.Count-1 do begin
        Obj:=TBisMessDataOutMessageRecipientInfo(ListBoxRecipients.Items.Objects[i]);
          ...
          if not VarIsNull(Contact) then begin
            if Flag then begin
              ...
              with Params do begin
                ...
                AddInvisible('ATTEMPTS').Value:=Provider.ParamByName('ATTEMPTS').Value;
              end;
            end;
          end;
          P1.Next;
...
function TBisMessDataOutMessageInsertExForm.AddRecipient(UserName,Surname,Name,Patronymic,Phone: String; AccountId: Variant;
                                                         IsRole: Boolean): TBisMessDataOutMessageRecipientInfo;
begin
  Result:=nil;
  if ListBoxRecipients.Items.IndexOf(UserName)=-1 then begin
    Result:=TBisMessDataOutMessageRecipientInfo.Create;
