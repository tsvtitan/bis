...
uses
  ...
  rxVCLUtils, rxStrUtils, rxFileUtil, rxPickDate, rxMaxMin, Themes;
      ...
      {$ENDIF}
        ...
        case AAlignment of
          ...
          taRightJustify:
            {$IFDEF RX_D10}
            // by TSV
            ALeft := Editor.ClientWidth - Editor.ButtonWidth - AWidth - Editor.Margins.Left;
//            ALeft := Editor.ClientWidth - Editor.ButtonWidth - AWidth - Editor.Margins.Left - 2;
            {$ELSE}
            // by TSV 
            ALeft := Editor.ClientWidth - Editor.ButtonWidth - AWidth - MyMargins.X;
