CREATE OR ALTER PROCEDURE GET_COUNT_IN_MESSAGES_REPORT (DATE_BEGIN Date,
       DATE_END   Date,
       CONTACT    Varchar(20))
...
begin
FOR
 SELECT MIN(GCO.DATE_IN) AS DATE_IN,
        GCO.DATE_YEAR_DAY,
        GCO.DATE_WEEKDAY,
        ...
        MIN(EXTRACT(WEEKDAY FROM CAST(('01.01.'||EXTRACT(YEAR FROM GCO.DATE_IN)) AS DATE)) - 1) AS FIRST_YEAR_DAY,                
       (CASE 
