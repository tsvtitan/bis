inherited BisCallcImportForm: TBisCallcImportForm
  ...
  object PanelPreview: TPanel
    ...
    object GroupBoxPreview: TGroupBox
      ...
      object PanelFile: TPanel
        ...
        object LabelDealPrefix: TLabel
          Left = 10
          Top = 8
          Width = 76
          Height = 13
          Alignment = taRightJustify
          Caption = #1055#1088#1077#1092#1080#1082#1089' '#1076#1077#1083#1072':'
          FocusControl = EditDealPrefix
        end
  ...
  object OpenDialog: TOpenDialog
    Filter = 
      'Xml '#1092#1072#1081#1083#1099' (*.xml)|*.xml|Excel '#1092#1072#1081#1083#1099' (*.xls)|*.xls|'#1042#1089#1077' '#1092#1072#1081#1083#1099' (*.*' +
      ')|*.*'
  ...
  object SaveDialogTemp: TSaveDialog
    DefaultExt = '*.tmp'
  ...
  object OpenDialogTemp: TOpenDialog
    Filter = 'Temp '#1092#1072#1081#1083#1099' (*.tmp)|*.tmp|'#1042#1089#1077' '#1092#1072#1081#1083#1099' (*.*)|*.*'
    Options = [ofEnableSizing]
    Left = 493
    Top = 149
