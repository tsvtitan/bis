  ...
  begin
    ...
    begin
      ...
      try
        ...
        try
          // by TSV
          if Success(WaveInOpen(nil, DeviceID, pWaveFormat, 0, 0, WAVE_FORMAT_QUERY or WAVE_MAPPED)) then
...
begin
  // by TSv
  Result := (WaveInOpen(nil, DeviceID, pWaveFormat, 0, 0, WAVE_FORMAT_QUERY or WAVE_MAPPED) = MMSYSERR_NOERROR);
//  Result := (WaveInOpen(nil, DeviceID, pWaveFormat, 0, 0, WAVE_FORMAT_QUERY) = MMSYSERR_NOERROR);
end;
