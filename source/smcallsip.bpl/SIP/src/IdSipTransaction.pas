...
{    // IIdSipTransactionListener
    ...
    // by TSV
    procedure OnFail(Transaction: TIdSipTransaction; FailedMessage: TIdSipMessage; const Reason: String); virtual;
    procedure OnReceiveRequest(Request: TIdSipRequest; Transaction: TIdSipTransaction; Binding: TIdConnectionBindings); overload; virtual;
    procedure OnReceiveResponse(Response: TIdSipResponse; Transaction: TIdSipTransaction; Binding: TIdConnectionBindings); overload; virtual;
 ...
 {   procedure OnException(FailedMessage: TIdSipMessage;
    ...
    // by TSV
    procedure OnException(FailedMessage: TIdSipMessage; E: Exception; const Reason: String); virtual;
    procedure OnReceiveRequest(Request: TIdSipRequest; Receiver: TIdSipTransport; Source: TIdConnectionBindings); overload; virtual;
    procedure OnReceiveResponse(Response: TIdSipResponse; Receiver: TIdSipTransport; Source: TIdConnectionBindings); overload; virtual;
    procedure OnRejectedMessage(const Msg: String; const Reason: String; Source: TIdConnectionBindings); virtual;
