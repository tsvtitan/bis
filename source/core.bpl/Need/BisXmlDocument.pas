...
//    function GetALNodeType: TALXmlNodeType;
  ...
  private
    ...
    procedure RefreshToALList(ALParentNode: TALXMLNode=nil);
  protected
...
procedure TBisXmlDocumentNodes.RefreshToALList(ALParentNode: TALXMLNode);
var
  i: Integer;
  Node: TBisXmlDocumentNode;
  ALNode: TALXMLNode;
  ...
  if Assigned(FDocument) then begin
    for i:=0 to Count-1 do begin
      ...
      if Assigned(ALNode) then begin
        ...
        Node.ALNode:=ALNode;
        Node.ChildNodes.RefreshToALList(Node.ALNode);
      end;
    end;
  end;
end;
