...
{ TIBTable }
  ...
  private
    ...
    FPrimaryIndexFields: WideString;
    ...
    function FormatFieldsList(Value: WideString): WideString;
...
function TIBTable.GetMasterFields: WideString;
begin
  Result := FMasterLink.FieldNames;
end;

procedure TIBTable.SetMasterFields(const Value: WideString);
begin
...
function TIBTable.FormatFieldsList(Value: WideString): WideString;
var
...
function TIBTable.PSGeTTableNameW: WideString;
begin
  Result := FTableName;
end;

procedure TIBTable.PSSetCommandText(const CommandText: WideString);
begin
...
function TIBTable.PSGetKeyFieldsW: WideString;
var
  i, Idx: Integer;
  IndexFound: Boolean;
begin
...
function TIBTable.PSGetCommandTextW: WideString;
begin
  Result := TableName;
end;
