...
#define AppName "Лото на Енисее"
#define OutputBaseFilename "loto_update_"+AppVersion
...
Source: {#AppBin}\config.ini; DestDir: {app}; Flags: onlyifdoesntexist; Components: client
...
[Icons]
Name: {userprograms}\{#AppPublisher}\{#AppName}\Запустить {#AppName}; Filename: {app}\loto.exe; WorkingDir: {app}; IconFilename: {app}\loto.exe; Comment: Запустить {#AppName} {#AppVersion}; IconIndex: 0; Components: client
...
[Components]
Name: client; Description: Лото на Енисее 1.0.0.120; Types: full; Flags: fixed
;Name: firebird; Description: Firebird Server 1.5.6.5026; Types: full
;Name: database; Description: База данных с тиражом 001; Types: full

[Run]
Filename: {app}\loto.exe; WorkingDir: {app}; Flags: nowait postinstall skipifsilent; Description: Запустить {#AppName}; Components: client
  ...
  case CurStep of
    ssPostInstall: begin
      ...
      if WizardForm.ComponentsList.Checked[0] then begin
        ...
        Exec(ExpandConstant('{app}\loto.exe'),'/nologin /command import import.imp',ExpandConstant('{app}'),SW_SHOWNORMAL,ewWaitUntilTerminated,ResultCode);
      end;
