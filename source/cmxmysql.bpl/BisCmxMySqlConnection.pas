...
begin
  ...
  SSqlUpdate:='UPDATE /*PREFIX*/SESSIONS SET DATE_CHANGE=CURRENT_TIMESTAMP, QUERY_TEXT=:QUERY_TEXT, DURATION=:DURATION '+
              'WHERE SESSION_ID=%s';
  SSqlUpdateParams:='UPDATE /*PREFIX*/SESSIONS SET DATE_CHANGE=CURRENT_TIMESTAMP, PARAMS=:PARAMS, '+
