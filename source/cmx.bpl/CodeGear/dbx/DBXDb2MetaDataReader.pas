...
function TDBXDb2MetaDataReader.GetProductName: WideString;
begin
  Result := 'Db2';
end;

function TDBXDb2MetaDataReader.GetTableType: WideString;
begin
  Result := 'T';
end;

function TDBXDb2MetaDataReader.GetViewType: WideString;
begin
  Result := 'V';
end;

function TDBXDb2MetaDataReader.GetSystemTableType: WideString;
begin
  Result := 'T';
end;

function TDBXDb2MetaDataReader.GetSqlProcedureQuoteChar: WideString;
begin
  Result := '';
end;
...
function TDBXDb2MetaDataReader.FetchCatalogs: TDBXTableStorage;
var
...
function TDBXDb2MetaDataReader.GetSqlForSchemas: WideString;
begin
  Result := 'SELECT CAST(NULL AS VARCHAR(1)), SCHEMANAME FROM SYSCAT.SCHEMATA ORDER BY 1';
end;

function TDBXDb2MetaDataReader.GetSqlForTables: WideString;
begin
...
function TDBXDb2MetaDataReader.GetSqlForViews: WideString;
begin
...
function TDBXDb2MetaDataReader.GetSqlForColumns: WideString;
begin
...
function TDBXDb2MetaDataReader.FetchColumnConstraints(const CatalogName: WideString; const SchemaName: WideString; const TableName: WideString): TDBXTableStorage;
var
  Columns: TDBXColumnDescriptorArray;
begin
...
function TDBXDb2MetaDataReader.GetSqlForIndexes: WideString;
begin
...
function TDBXDb2MetaDataReader.GetSqlForIndexColumns: WideString;
begin
...
function TDBXDb2MetaDataReader.GetSqlForForeignKeys: WideString;
begin
...
function TDBXDb2MetaDataReader.GetSqlForForeignKeyColumns: WideString;
begin
...
function TDBXDb2MetaDataReader.GetSqlForSynonyms: WideString;
begin
...
function TDBXDb2MetaDataReader.GetSqlForProcedures: WideString;
begin
...
function TDBXDb2MetaDataReader.GetSqlForProcedureSources: WideString;
begin
...
function TDBXDb2MetaDataReader.GetSqlForProcedureParameters: WideString;
begin
...
function TDBXDb2MetaDataReader.FetchPackages(const CatalogName: WideString; const SchemaName: WideString; const PackageName: WideString): TDBXTableStorage;
var
  Columns: TDBXColumnDescriptorArray;
begin
...
function TDBXDb2MetaDataReader.FetchPackageProcedures(const CatalogName: WideString; const SchemaName: WideString; const PackageName: WideString; const ProcedureName: WideString; const ProcedureType: WideString): TDBXTableStorage;
var
  Columns: TDBXColumnDescriptorArray;
begin
...
function TDBXDb2MetaDataReader.FetchPackageProcedureParameters(const CatalogName: WideString; const SchemaName: WideString; const PackageName: WideString; const ProcedureName: WideString; const ParameterName: WideString): TDBXTableStorage;
var
  Columns: TDBXColumnDescriptorArray;
begin
...
function TDBXDb2MetaDataReader.FetchPackageSources(const CatalogName: WideString; const SchemaName: WideString; const PackageName: WideString): TDBXTableStorage;
var
  Columns: TDBXColumnDescriptorArray;
begin
...
function TDBXDb2MetaDataReader.FetchUsers: TDBXTableStorage;
var
  Columns: TDBXColumnDescriptorArray;
begin
...
function TDBXDb2MetaDataReader.GetSqlForRoles: WideString;
begin
  Result := 'SELECT NGNAME FROM SYSCAT.NODEGROUPS';
end;

function TDBXDb2MetaDataReader.GetVersion: WideString;
begin
...
begin
  ...
  Types[3] := TDBXDataTypeDescription.Create('REAL', TDBXDataTypesEx.SingleType, 7, 'REAL', NullString, -1, -1, NullString, NullString, NullString, NullString, TDBXTypeFlag.BestMatch or TDBXTypeFlag.FixedLength or TDBXTypeFlag.Nullable or TDBXTypeFlag.Searchable);
...
function TDBXDb2MetaDataReader.GetReservedWords: TDBXWideStringArray;
var
