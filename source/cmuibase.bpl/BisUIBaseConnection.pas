...
//  FTransaction:=TBisUIBaseTransaction.Create(nil);
  ...
  FSLoadProfileFail:='Профиль не загружен. %s';
  ...
  FSSaveProfileFail:='Профиль не сохранен. %s';
  ...
  FSLoadInterfacesFail:='Интерфейсы не загружены. %s';
  ...
  FSGetRecordsFail:='Записи не получены. %s';

  FSCollectionGetRecordsStart:='Начало получения коллекции ...';
  FSCollectionGetRecordsEnd:='Окончание получения коллекции ...';

  FSExecuteStart:='Начало выполнения процедуры ...';
  FSExecuteSetParams:='Параметры заданы. Запуск процедуры ...';
  ...
  FSExecuteFail:='Процедура не выполнена. %s';

  FSLoadMenusStart:='Начало загрузки меню ...';
  FSLoadMenusSql:='Запрос загрузки меню => %s';
  FSLoadMenusSuccess:='Меню загружено успешно.';
  FSLoadMenusFail:='Меню не загружено. %s';

  FSLoadTasksStart:='Начало загрузки заданий ...';
  FSLoadTasksSql:='Запрос загрузки заданий => %s';
  FSLoadTasksSuccess:='Задания загружены успешно.';
  FSLoadTasksFail:='Задания не загружены. %s';

  FSSaveTaskStart:='Начало сохранения задания ...';
  FSSaveTaskSql:='Запрос сохранения задания => %s';
  FSSaveTaskSuccess:='Задание сохранено успешно.';
  FSSaveTaskFail:='Задание не сохранено. %s';

  FSLoadAlarmsStart:='Начало загрузки оповещений ...';
  FSLoadAlarmsSql:='Запрос загрузки оповещений => %s';
  FSLoadAlarmsSuccess:='Оповещения загружены успешно.';
  FSLoadAlarmsFail:='Оповещени не загружены. %s';
  ...
  FSLoadScriptFail:='Скрипт не загружен. %s';
  ...
  FSLoadReportFail:='Отчет не загружен. %s';
  ...
  FSLoadDocumentFail:='Документ не загружен. %s';
...
//  Core.ExceptNotifier.IngnoreExceptions.Add(EIBInterBaseError);
  ...
  FSImportScriptStart:='Начало выполнения импорта скрипта ...';
  FSImportScriptSql:='Текст запроса => %s';
  FSImportScriptSuccess:='Импорт скрипта выполнен успешно.';
  FSImportScriptFail:='Импорт скрипта не выполнен. %s';

  FSImportTableStart:='Начало выполнения импорта таблицы ...';
  FSImportTableSql:='Текст запроса => %s';
  FSImportTableSuccess:='Импорт таблицы выполнен успешно.';
  FSImportTableEmpty:='Таблица не активная или пустая.';
  FSImportTableFail:='Импорт таблицы не выполнен. %s';
  FSImportTableParam:='Параметр => %s Тип параметра => %s Тип данных => %s Значение => %s';

  FSDeleteStatementsSql:='Запрос удаления запросов => %s';
