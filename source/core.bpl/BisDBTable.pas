...
uses Classes, DB, DBCtrls, Windows, Grids, DBGrids,
     kbmMemTable,
...
procedure TBisDBTable.DrawColumnCell(const Rect: TRect; DataCol: Integer;
...
begin
  if not (gdFocused in State) and (gdSelected in State) then begin
    ...
    try
      ...
      Canvas.TextOut(Rect.Left+2,Rect.Top+2,Column.Field.Text);
    finally
