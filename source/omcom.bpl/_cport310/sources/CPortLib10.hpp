...
// (DO NOT EDIT: machine generated header) 'Cportlib10.pas' rev: 11.00

#ifndef Cportlib10HPP
#define Cportlib10HPP
...
#include <Cportsetup.hpp>	// Pascal unit
#include <Cportctl.hpp>	// Pascal unit
#include <Cportesc.hpp>	// Pascal unit
#include <Cporttrmset.hpp>	// Pascal unit
#include <Gnugettext.hpp>	// Pascal unit
...
namespace Cportlib10
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Cportlib10 */
using namespace Cportlib10;
#pragma pack(pop)
#pragma option pop
