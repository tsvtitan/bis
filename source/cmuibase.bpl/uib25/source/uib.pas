...
//          ftChar, uftVarchar, uftCstring
          case Fields.AsSmallint[0] of
            blr_text      : Params.AddFieldType(Trim(AsString[1]), uftChar);
            blr_text2     : Params.AddFieldType(Trim(AsString[1]), uftChar);
            blr_varying   : Params.AddFieldType(Trim(AsString[1]), uftVarchar);
            blr_varying2  : Params.AddFieldType(Trim(AsString[1]), uftVarchar);
            blr_cstring   : Params.AddFieldType(Trim(AsString[1]), uftCstring);
            blr_cstring2  : Params.AddFieldType(Trim(AsString[1]), uftCstring);
            blr_float,
