...
type
  ...
  public
    ...
    function Find(Name: String; Channels: Word; SamplesPerSec: LongWord; BitsPerSample: Word): TBisAcmDriverFormat; overload;
    function Find(Tag: LongWord; Channels: Word; SamplesPerSec: LongWord; BitsPerSample: Word): TBisAcmDriverFormat; overload;
  ...
  public
    ...
    function FindFormat(DriverName, FormatName: String; Channels: Word;
                        SamplesPerSec: LongWord; BitsPerSample: Word): TBisAcmDriverFormat; overload;
...
function TBisAcmDriverFormats.Find(Name: String; Channels: Word; SamplesPerSec: LongWord;  BitsPerSample: Word): TBisAcmDriverFormat;
var
  i: Integer;
...
function TBisAcmDriverFormats.Find(Tag: LongWord; Channels: Word; SamplesPerSec: LongWord; BitsPerSample: Word): TBisAcmDriverFormat;
var
  i: Integer;
  Item: TBisAcmDriverFormat;
begin
...
function TBisAcmDriverFormats.GetName(FormatTag: LongWord): String;
var
  i: Integer;
  Item: TBisAcmDriverFormat;
begin
...
function TBisAcmDrivers.GetFormatName(FormatTag: LongWord): String;
var
  i: Integer;
  Driver: TBisAcmDriver;
begin
...
function TBisAcmDrivers.FindFormat(DriverName, FormatName: String; Channels: Word;
                                    SamplesPerSec: LongWord; BitsPerSample: Word): TBisAcmDriverFormat;
var
  i: Integer;
  Driver: TBisAcmDriver;
  Format: TBisAcmDriverFormat;
...
function TBisAcmDrivers.FindFormat(DriverName: String; FormatTag: LongWord; Channels: Word;
                                    SamplesPerSec: LongWord; BitsPerSample: Word): TBisAcmDriverFormat;
var
  i: Integer;
  Driver: TBisAcmDriver;
