...
type
  ...
  public
    function AddPoint(Lat, Lon: Double): TBisMapFramePoint;
  ...
  protected
    ...
    function GetCurrentLat: Double; virtual;
    function GetCurrentLon: Double; virtual;
  public
    ...
    function GetDirectDistance(Lat1, Lon1, Lat2, Lon2: Double): Double; virtual;
    function GetRouteDistance(Lat1, Lon1, Lat2, Lon2: Double): Double; overload; virtual;
    function GetRouteDistance(Points: TBisMapFramePoints): Double; overload; virtual;
    ...
    property CurrentLat: Double read GetCurrentLat;
    property CurrentLon: Double read GetCurrentLon;
...
function TBisMapFramePoints.AddPoint(Lat, Lon: Double): TBisMapFramePoint;
begin
...
procedure TBisMapFrame.PrepareMap;
begin
end;
...
function TBisMapFrame.GetCurrentLat: Double;
begin
  Result:=0.0;
end;

function TBisMapFrame.GetCurrentLon: Double;
begin
  Result:=0.0;
end;

function TBisMapFrame.GetDirectDistance(Lat1, Lon1, Lat2, Lon2: Double): Double;
begin
  Result:=0.0;
end;

function TBisMapFrame.GetRouteDistance(Lat1, Lon1, Lat2, Lon2: Double): Double;
begin
  Result:=0.0;
end;

function TBisMapFrame.GetRouteDistance(Points: TBisMapFramePoints): Double;
begin
  Result:=0.0;
end;
