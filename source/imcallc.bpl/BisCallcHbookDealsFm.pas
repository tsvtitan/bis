...
begin
  ...
  with FieldNames do begin
    ...
    Add('DEAL_NUM','Номер дела',90);
    Add('DATE_ISSUE','Дата передачи',70);
    Add('DEBTOR_NAME','Должник',240);
    Add('ARREAR_PERIOD','Период',60);
    Add('INITIAL_DEBT','Долг',90).DisplayFormat:=SDisplayFormatFloat;
  end;
  Orders.Add('DEAL_NUM');
end;
