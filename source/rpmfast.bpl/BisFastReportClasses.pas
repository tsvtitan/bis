...
type
  ...
  private
    ...
    FOnBeforePrepareReport: TNotifyEvent;
  ...
  public
    ...
    property OnBeforePrepareReport: TNotifyEvent read FOnBeforePrepareReport write FOnBeforePrepareReport; 
  end;
...
procedure TBisFastReport.DoBeforePrepareReport;
begin
  if Assigned(FOnBeforePrepareReport) then
    FOnBeforePrepareReport(Self);  
end;
