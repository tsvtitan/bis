...
type
  ...
  private
    FDealId: Variant;
    FDealNum: String;
    FOnAfterEditFormExecute: TBisDataEditFormExecuteEvent;
  ...
  public
    ...
    property OnAfterEditFormExecute: TBisDataEditFormExecuteEvent read FOnAfterEditFormExecute write FOnAfterEditFormExecute;
  end;
...
begin
  ...
  if Assigned(Result) then begin
    ...
    TBisCallcDealFramePaymentEditFormIface(Result).OnAfterExecute:=FOnAfterEditFormExecute;
  end;
end;
