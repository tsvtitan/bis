unit BisMessageServerGsmModemsFm;
...
type
  TBisMessageServerGsmModemsForm = class(TBisDialogForm)
    ButtonSave: TButton;
  ...
  TBisMessageServerGsmModemsFormIface=class(TBisDialogFormIface)
  private
    FShowByCommand: Boolean;
  protected
...
var
  BisMessageServerGsmModemsForm: TBisMessageServerGsmModemsForm;

implementation

{$R *.dfm}

uses BisCoreIntf, BisCore, BisDialogs, BisUtils, BisGsmModem, BisComPort, BisMessageServerGsmConsts,
     BisServerModules, BisServers;

{ TBisMessageServerGsmModemsFormIface }

function TBisMessageServerGsmModemsFormIface.CreateForm: TBisForm;
begin
  Result:=inherited CreateForm;
  if Assigned(Result) then
    TBisMessageServerGsmModemsForm(Result).ShowByCommand:=FShowByCommand;
end;

class function TBisMessageServerGsmModemsFormIface.GetFormClass: TBisFormClass;
begin
  Result:=TBisMessageServerGsmModemsForm;
end;

procedure TBisMessageServerGsmModemsFormIface.ShowByCommand(const Command: string);
begin
  FShowByCommand:=true;
  ShowModal;
end;

{ TBisMessageServerGsmModemsForm }

constructor TBisMessageServerGsmModemsForm.Create(AOwner: TComponent);
var
  Buffer: String;
begin
  ...
  FSAllMessages:='Все сообщения';
  FSOnlyIncoming:='Входящие';
  FSOnlyOutgoing:='Исходящие';
  FSParitybitsNone:='нет';
  FSParitybitsOdd:='нечетный';
  FSParitybitsEven:='четный';
  FSParitybitsMark:='маркер';
  FSParitybitsSpace:='пробел';
...
destructor TBisMessageServerGsmModemsForm.Destroy;
begin
  FModems.Free;
  inherited Destroy;
end;

procedure TBisMessageServerGsmModemsForm.Init;
var
  OldIndex: Integer;
begin
  inherited Init;
...
procedure TBisMessageServerGsmModemsForm.FillDefault;
var
  i: Integer;
begin
...
procedure TBisMessageServerGsmModemsForm.LoadFromBase;
var
  i: Integer;
  Server: TBisServer;
...
procedure TBisMessageServerGsmModemsForm.EnableModems(AEnabled: Boolean);
begin
...
procedure TBisMessageServerGsmModemsForm.CheckBoxEnabledClick(Sender: TObject);
begin
...
procedure TBisMessageServerGsmModemsForm.SetModems(Port: String);
begin
...
procedure TBisMessageServerGsmModemsForm.GetModems(Port: String);
begin
  if FModems.Locate('PORT',Port,[loCaseInsensitive]) then begin
...
procedure TBisMessageServerGsmModemsForm.ComboBoxComportChange(Sender: TObject);
begin
...
function TBisMessageServerGsmModemsForm.CheckFields: Boolean;
begin
  Result:=false;
...
procedure TBisMessageServerGsmModemsForm.ButtonOkClick(Sender: TObject);
begin
...
procedure TBisMessageServerGsmModemsForm.ButtonSaveClick(Sender: TObject);
begin
  if CheckFields then
    SaveModems;
end;

procedure TBisMessageServerGsmModemsForm.ButtonTestClick(Sender: TObject);
begin
  if CheckFields then
    TestModem;
end;

procedure TBisMessageServerGsmModemsForm.SetOnlyOneModem(const Value: Boolean);
begin
  FOnlyOneModem:= Value;
...
procedure TBisMessageServerGsmModemsForm.TestModem;
var
  Modem: TBisGsmModem;
  OldCursor: TCursor;
  S: String;
...
procedure TBisMessageServerGsmModemsForm.SaveModems;
var
  i: Integer;
  Server: TBisServer;
  Param: TBisServerParam;
...
procedure TBisMessageServerGsmModemsForm.RestartServer;
var
  i: Integer;
  Server: TBisServer;
begin
