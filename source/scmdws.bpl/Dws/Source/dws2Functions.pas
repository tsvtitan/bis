...
procedure TEmptyFunc.Call(Caller: TProgram; Func: TFuncSymbol; Expr: TExpr);
begin
end;
...
procedure TInternalFunction.Call(Caller: TProgram; Func: TFuncSymbol; Expr: TExpr);
begin
  FInfo.Caller := Caller;
  Execute;
end;
...
procedure TInternalMethod.Call(Caller: TProgram; Func: TFuncSymbol; Expr: TExpr);
var
...
procedure TAnonymousFunction.Call(Caller: TProgram; Func: TFuncSymbol; Expr: TExpr);
begin
  FInfo.Caller := Caller;
  Execute;
end;
...
procedure TAnonymousMethod.Call(Caller: TProgram; Func: TFuncSymbol; Expr: TExpr);
var
  scriptObj: IScriptObj;
  extObj: TObject;
begin
