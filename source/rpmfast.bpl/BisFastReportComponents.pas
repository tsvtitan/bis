...
initialization
  ...
  frxResources.Add('propProviderName','Имя провайдера данных на сервере');
  frxResources.Add('propFetchCount','Количество записей, запрашиваемых с сервера. Значение -1 все записи');
  frxResources.Add('propFieldNames','Список полей, используемых для запроса с сервера. Пустой список все поля');
  frxResources.Add('propOrders','Сортировка данных на сервере');
  frxResources.Add('propFilterGroups','Фильтрация данных на сервере');
