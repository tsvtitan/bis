...
begin
  ...
  with FieldNames do begin
    ...
    Add('STREET_NAME','Улица',140);
    Add('HOUSE','Дом',50).IsKey:=true;
    Add('LOCALITY_NAME','Населенный пункт',95);
    Add('LAT','Широта',105).DisplayFormat:='#0.000000000';
    Add('LON','Долгота',105).DisplayFormat:='#0.000000000';
  end;
