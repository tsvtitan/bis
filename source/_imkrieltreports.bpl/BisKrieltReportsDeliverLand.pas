...
begin
  ...
  XLSNew:=CopyExcelDocToNew('deliver_land_others.xls','Сдам_землю_в_других_населенных_пунктах');
  Excel:=OpenExcelDoc(XLSNew);
  Sheet:=Excel.ActiveSheet;
...
begin
  ...
  XLSNew:=CopyExcelDocToNew('deliver_land_out_point.xls','Сдам_землю_за_населенными_пунктами');
  Excel:=OpenExcelDoc(XLSNew);
  Sheet:=Excel.ActiveSheet;
