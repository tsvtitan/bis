...
type
  ...
  private
    ...
    function GetCount(Instance: TObject; ClassType: TClass; const PropName: String): Variant;  
  public
...
begin
  ...
  begin
    ...
    begin
      ...
      AddProperty('Count','Integer',GetCount,nil);
    end;
    ...
    begin
      ...
      AddConst('csBar','TfrxChartSeries',csBar);
      AddConst('csHorizBar','TfrxChartSeries',csHorizBar);
      AddConst('csPie','TfrxChartSeries',csPie);
...
function TFunctions.GetCount(Instance: TObject; ClassType: TClass; const PropName: String): Variant;
begin
  Result := 0;
  if AnsiSameText(PropName,'Count') then begin
    Result:=TfrxSeriesData(Instance).Count;
  end;
end;
