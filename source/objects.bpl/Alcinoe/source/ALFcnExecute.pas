...
function ALWinExec32(const ApplicationName, CommandLine, CurrentDirectory, Environment: string; InputStream: Tstream; OutputStream: TStream): Dword;
...
{*****************************************}
function ALWinExec32(const ApplicationName,
                           CommandLine,
                           CurrentDirectory,
                           Environment: string;
                     InputStream: Tstream;
  ...
  Try
    ...
    Try
      ...
      if not CreateProcess(
                           ...
                           PChar(ApplicationName + ' ' + CommandLine), // pointer to command line string
                           @aSecurityAttributes,                       // pointer to process security attributes
                           NiL,                                        // pointer to thread security attributes
                           TrUE,                                       // handle inheritance flag
                           CREATE_NEW_CONSOLE,                         // creation flags
                           PChar(Environment),                         // pointer to new environment block
                           PChar(CurrentDirectory),                    // pointer to current directory name
