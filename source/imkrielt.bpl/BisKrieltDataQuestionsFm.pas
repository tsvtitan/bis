...
uses
  ...
  BisFm, BisDataFrm,
  BisDataGridFm, BisKrieltDataQuestionsFrm;
...
begin
  ...
  with FieldNames do begin
    ...
    Add('SUBJECT_NAME','Тема',170);
    Add('NAME','Имя',80);
    Add('CONTACT','Контакт',130);
  end;
...
class function TBisKrieltDataQuestionsForm.GetDataFrameClass: TBisDataFrameClass;
begin
  Result:=TBisKrieltDataQuestionsFrame;
end;
