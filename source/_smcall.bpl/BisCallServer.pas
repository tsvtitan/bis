...
begin
  ...
  FSStart:='Загрузка модулей...';
  FSStartSuccess:='Модули загружены успешно.';
  FSStartFail:='Модули загружены с ошибкой: %s';
  FSStop:='Выгрузка модулей...';
  FSStopSuccess:='Модули выгружены успешно.';
  FSStopFail:='Модули выгружены с ошибкой: %s';
