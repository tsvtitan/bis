...
type
  TBisCallcTaskFrameChangeControlsEvent=procedure(AEnabled: Boolean; TaskChanged: Boolean) of object;
  ...
  private
    ...
    FTaskName: String;
    FActionId: Variant;
    FOnChangeControls: TBisCallcTaskFrameChangeControlsEvent;
    FUseUnlock: Boolean;
  ...
  public
    ...
    property UseUnlock: Boolean read FUseUnlock write FUseUnlock;
    property OnlyOneTask: Boolean read FOnlyOneTask write FOnlyOneTask; 

    property OnChangeControls: TBisCallcTaskFrameChangeControlsEvent read FOnChangeControls write FOnChangeControls;
  end;
