...
unit DBXSybaseASEMetaDataReader;
interface
uses
  DBXMetaDataNames,
  DBXMetaDataReader,
...
type
  ...
  /// <summary>  AseCustomMetaDataProvider contains custom code for Adaptive Server Enterprise.
  /// </summary>
  TDBXSybaseASECustomMetaDataReader = class abstract(TDBXBaseMetaDataReader)
  public
    type

      /// <summary>  SybaseForeignKeyColumnsCursor is a filter for a cursor providing foreign key columns.
      /// </summary>
      ...
      ///   columns and the primary key columns are split into 2 queries.
      /// </remarks>
      TDBXSybaseASEForeignKeyColumnsCursor = class(TDBXBaseMetaDataReader.TDBXSanitizedTableCursor)
      public
      ...
      protected
        constructor Create(const Provider: TDBXSybaseASECustomMetaDataReader; const Columns: TDBXColumnDescriptorArray; const Cursor1: TDBXTableStorage; const Cursor2: TDBXTableStorage);
      private
        FCursor2: TDBXTableStorage;
        FKeyIndex: Integer;
  ...
  protected
    ...
    /// </summary>
    /// <remarks>  A concrete super class of SybaseCustomMetaDataProvider must implement this
    ///   property and supply a query that includes the column names of the table being referenced.
    /// </remarks>
    function GetSqlForForeignKeyColumnsPart2: WideString; virtual; abstract;
  protected
    ...
    ///   property and supply a query that includes the column names of the table being referenced.
    /// </remarks>
    property SqlForForeignKeyColumnsPart2: WideString read GetSqlForForeignKeyColumnsPart2;
  end;
  ...
  protected
    ...
    function GetSqlForForeignKeyColumnsPart2: WideString; override;
...
begin
  ...
  Cursor1 := FContext.ExecuteQuery(SqlForForeignKeyColumns, ParameterNames, ParameterValues);
  Cursor2 := FContext.ExecuteQuery(SqlForForeignKeyColumnsPart2, ParameterNames, ParameterValues);
...
constructor TDBXSybaseASECustomMetaDataReader.TDBXSybaseASEForeignKeyColumnsCursor.Create(const Provider: TDBXSybaseASECustomMetaDataReader; const Columns: TDBXColumnDescriptorArray; const Cursor1: TDBXTableStorage; const Cursor2: TDBXTableStorage);
begin
  inherited Create(Provider.FContext, TDBXMetaDataCollectionIndex.ForeignKeyColumns, TDBXMetaDataCollectionName.ForeignKeyColumns, Columns, Cursor1);
...
begin
  repeat
    ...
    begin
      ...
      FKeyIndex := 0;
      FKeyColumnCount := FCursor.GetAsInt32(OrdinalKeyColumnCount);
    end;
  until FKeyIndex < FKeyColumnCount;
  Result := True;
end;

function TDBXSybaseASECustomMetaDataReader.TDBXSybaseASEForeignKeyColumnsCursor.IsNull(Ordinal: Integer): Boolean;
begin
  case Ordinal of
    TDBXForeignKeyColumnsIndex.ColumnName:
      Result := FCursor.IsNull(OrdinalFirstColumn + FKeyIndex);
    TDBXForeignKeyColumnsIndex.PrimaryColumnName:
      Result := FCursor2.IsNull(OrdinalFirstColumn + FKeyIndex);
    else
      Result := inherited IsNull(Ordinal);
  end;
end;

function TDBXSybaseASECustomMetaDataReader.TDBXSybaseASEForeignKeyColumnsCursor.GetString(Ordinal: Integer): WideString;
begin
  case Ordinal of
    TDBXForeignKeyColumnsIndex.ColumnName:
      Result := FCursor.GetAsString(OrdinalFirstColumn + FKeyIndex);
    TDBXForeignKeyColumnsIndex.PrimaryColumnName:
      Result := FCursor2.GetAsString(OrdinalFirstColumn + FKeyIndex);
    else
      Result := inherited GetString(Ordinal);
  end;
end;

function TDBXSybaseASECustomMetaDataReader.TDBXSybaseASEForeignKeyColumnsCursor.GetInt32(Ordinal: Integer): Integer;
begin
...
function TDBXSybaseASEMetaDataReader.GetProductName: WideString;
begin
  Result := 'Sybase SQL Server';
end;

function TDBXSybaseASEMetaDataReader.GetTableType: WideString;
begin
  Result := 'U';
end;

function TDBXSybaseASEMetaDataReader.GetViewType: WideString;
begin
  Result := 'V';
end;

function TDBXSybaseASEMetaDataReader.GetSystemTableType: WideString;
begin
  Result := 'S';
end;
...
function TDBXSybaseASEMetaDataReader.GetSqlIdentifierQuoteChar: WideString;
begin
  Result := '';
end;

function TDBXSybaseASEMetaDataReader.GetSqlProcedureQuoteChar: WideString;
begin
  Result := '';
end;
...
function TDBXSybaseASEMetaDataReader.FetchCatalogs: TDBXTableStorage;
var
  Columns: TDBXColumnDescriptorArray;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForSchemas: WideString;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForTables: WideString;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForViews: WideString;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForColumns: WideString;
begin
...
function TDBXSybaseASEMetaDataReader.FetchColumnConstraints(const CatalogName: WideString; const SchemaName: WideString; const TableName: WideString): TDBXTableStorage;
var
  Columns: TDBXColumnDescriptorArray;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForIndexes: WideString;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForIndexColumns: WideString;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForForeignKeys: WideString;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForForeignKeyColumns: WideString;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForForeignKeyColumnsPart2: WideString;
begin
  Result := 'SELECT DB_NAME(), USER_NAME(ft.uid), ft.name, fk.name, NULL, DB_NAME(), USER_NAME(pt.uid), pt.name, pi.name, NULL, r.keycnt, ' +
...
function TDBXSybaseASEMetaDataReader.FetchSynonyms(const CatalogName: WideString; const SchemaName: WideString; const SynonymName: WideString): TDBXTableStorage;
var
  Columns: TDBXColumnDescriptorArray;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForProcedures: WideString;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForProcedureSources: WideString;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForProcedureParameters: WideString;
begin
...
function TDBXSybaseASEMetaDataReader.FetchPackages(const CatalogName: WideString; const SchemaName: WideString; const PackageName: WideString): TDBXTableStorage;
var
  Columns: TDBXColumnDescriptorArray;
begin
...
function TDBXSybaseASEMetaDataReader.FetchPackageProcedures(const CatalogName: WideString; const SchemaName: WideString; const PackageName: WideString; const ProcedureName: WideString; const ProcedureType: WideString): TDBXTableStorage;
var
  Columns: TDBXColumnDescriptorArray;
begin
...
function TDBXSybaseASEMetaDataReader.FetchPackageProcedureParameters(const CatalogName: WideString; const SchemaName: WideString; const PackageName: WideString; const ProcedureName: WideString; const ParameterName: WideString): TDBXTableStorage;
var
  Columns: TDBXColumnDescriptorArray;
begin
...
function TDBXSybaseASEMetaDataReader.FetchPackageSources(const CatalogName: WideString; const SchemaName: WideString; const PackageName: WideString): TDBXTableStorage;
var
  Columns: TDBXColumnDescriptorArray;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForUsers: WideString;
begin
  Result := 'SELECT name FROM dbo.sysusers WHERE uid > 0 AND suid >= -1';
end;

function TDBXSybaseASEMetaDataReader.GetSqlForRoles: WideString;
begin
...
begin
  ...
  Types[16] := TDBXDataTypeDescription.Create('real', TDBXDataTypesEx.SingleType, 7, 'real', NullString, -1, -1, NullString, NullString, NullString, NullString, TDBXTypeFlag.FixedLength or TDBXTypeFlag.Nullable or TDBXTypeFlag.Searchable);
  ...
  Types[24] := TDBXDataTypeDescription.Create('tinyint', TDBXDataTypesEx.UInt8Type, 3, 'tinyint', NullString, -1, -1, NullString, NullString, NullString, NullString, TDBXTypeFlag.FixedLength or TDBXTypeFlag.FixedPrecisionScale or TDBXTypeFlag.Nullable or TDBXTypeFlag.Searchable or TDBXTypeFlag.Unsigned);
...
function TDBXSybaseASEMetaDataReader.GetReservedWords: TDBXWideStringArray;
var
