...
begin
  ...
  FSNameAuto:='Автоопределение';
  FSCacheFileNotFound:='Кэш-файл %s не найден.';
  FSErrorNotFound:='Нет данных об ошибке.';
  FSConnectionCaption:='%s [%s]';
  FSServerDoesNotExists:='Нарушен канал связи или отключен сервер.';
end;
