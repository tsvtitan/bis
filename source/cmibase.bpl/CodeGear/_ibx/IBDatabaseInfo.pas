...
begin
  ...
  result := FGDSLibrary.isc_vax_integer(@local_buffer[4], 1);
end;
...
begin
  ...
  Call(FGDSLibrary.isc_database_info(StatusVector, @FDatabase.Handle, 1, @DatabaseInfoCommand,
                        IBLocalBufferLength, local_buffer), True);
  result := FGDSLibrary.isc_vax_integer(@local_buffer[3], 1);
end;
...
begin
  ...
  qtd_tables := FGDSLibrary.isc_vax_integer(@local_buffer[1],2) div 6;
  for i := 0 to qtd_tables - 1 do
  begin
    id_table := FGDSLibrary.isc_vax_integer(@local_buffer[3+(i*6)],2);
    qtd_operations := FGDSLibrary.isc_vax_integer(@local_buffer[5+(i*6)],4);
...
begin
  ...
  Call(FGDSLibrary.isc_database_info(StatusVector, @FDatabase.Handle, 1, @_DatabaseInfoCommand,
                         IBLocalBufferLength, local_buffer), True);
  length := FGDSLibrary.isc_vax_integer(@local_buffer[1], 2);
  result := FGDSLibrary.isc_vax_integer(@local_buffer[3], length);
end;
