...
procedure TIBQuery.PSSetCommandText(const CommandText: WideString);
begin
  if SQL.Text <> CommandText then
...
function TIBQuery.PSGetTableNameW: WideString;
begin
  Result := inherited PSGetTableNameW;
end;
...
function TIBQuery.PSGetCommandTextW: WideString;
begin
  Result := SQL.Text;
end;
