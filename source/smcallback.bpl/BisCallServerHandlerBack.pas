...
begin
  ...
  FSGetAudioStart:='Получение аудио для текста (%s) ...';
  FSGetAudioSuccess:='Получение аудио выполнено успешно. Всего фраз %d';
  FSGetAudioFail:='Получение аудио не выполнено. %s';
