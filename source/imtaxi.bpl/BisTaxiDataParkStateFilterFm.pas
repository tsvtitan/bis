...
begin
  ...
  with Params do begin
    ...
    with AddEditDateTime('DATE_IN','DateTimePickerInTo','DateTimePickerInToTime','LabelDateInTo') do begin
      FilterCaption:='Дата постановки по:';
