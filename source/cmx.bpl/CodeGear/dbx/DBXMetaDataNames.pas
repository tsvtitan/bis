...
type
  ...
  public
    ...
    ///   <p>The data in this column specifies the precision of this type.
    /// </summary>
    /// <remarks> <br>
    ///   For a string data type, this is the maximum number of characters. <br>
    ///   For a decimal types, this is the maximum number digits including
    ///   digits from the scale.</p>
    /// </remarks>
  ...
  public
    ...
    ///   <p>The data in this column specifies the length of this type.
    /// </summary>
    /// <remarks> <br>
    ///   For a string data type, this is the maximum number of characters. <br>
    ...
    ///   <c>DbxDataType</c> column.
    /// </summary>
    /// <remarks> <br>
    ///   Reserved for .NET applications.</p>
    /// </remarks>
  ...
  public
    ...
    /// </summary>
    /// <remarks> <br>
    ///   This is usually the primary key.</p>
    /// </remarks>
  ...
  public
    ...
    ///    <tr><td>TypeName</td><td>String</td><td>The database specific data type name.</td></tr>
    ///    <tr><td>DbxDataType</td><td>Int32</td><td>The DBX data type.</td></tr>
    ///    <tr><td>ColumnSize</td><td>Int64</td><td>The length of this type.
    /// </summary>
    /// <remarks> <br> For a string data type, this is the maximum number of characters. <br> For a floating point number, this is the number of significant bits in the mantissa. <br> For other numeric types, this is the maximum number of significant digits. <br> For a date, time, and timestamp types, this is the length of the string representation.</td></tr>
    ///    <tr><td>CreateFormat</td><td>String</td><td>The create format as used in CREATE TABLE.</td></tr>
    ///    <tr><td>CreateParameters</td><td>String</td><td>The parameters for the create format.</td></tr>
    ///    <tr><td>DataType</td><td>String</td><td>The name of the language type representing this data type.</td></tr>
    ///    <tr><td>IsAutoIncrementable</td><td>Boolean</td><td>Can be used as for an autoincrement column.</td></tr>
    ///    <tr><td>IsBestMatch</td><td>Boolean</td><td>Is the best match for the language type.</td></tr>
    ///    <tr><td>IsCaseSensitive</td><td>Boolean</td><td>Is case sensitive.</td></tr>
    ///    <tr><td>IsFixedLength</td><td>Boolean</td><td>Is fixed length.</td></tr>
    ///    <tr><td>IsFixedPrecisionScale</td><td>Boolean</td><td>Is an exact numeric.</td></tr>
    ///    <tr><td>IsLong</td><td>Boolean</td><td>Is a blob type.</td></tr>
    ///    <tr><td>IsNullable</td><td>Boolean</td><td>Can be assigned a value of NULL.</td></tr>
    ///    <tr><td>IsSearchable</td><td>Boolean</td><td>Can be searched in the SQL database.</td></tr>
    ///    <tr><td>IsSearchableWithLike</td><td>Boolean</td><td>Can be search with the SQL LIKE operator.</td></tr>
    ///    <tr><td>IsUnsigned</td><td>Boolean</td><td>Is an unsigned numeric.</td></tr>
    ...
    ///    <tr><td>IsConcurrencyType</td><td>Boolean</td><td>Has special update semantics.</td></tr>
    ///    <tr><td>MaximumVersion</td><td>String</td><td>The last database product version where this type was avaliable.</td></tr>
    ///    <tr><td>MinimumVersion</td><td>String</td><td>The first database product version where this type was available.</td></tr>
    ///    <tr><td>IsLiteralSupported</td><td>Boolean</td><td>Can be represented as a SQL literal.</td></tr>
    ///    <tr><td>LiteralPrefix</td><td>String</td><td>The prefix of a SQL literal.</td></tr>
    ///    <tr><td>LiteralSuffix</td><td>String</td><td>The suffix of a SQL literal.</td></tr>
    ///    <tr><td>IsUnicode</td><td>Boolean</td><td>Can hold unicode character data.</td></tr>
    ///    <tr><td>ProviderDbType</td><td>Int32</td><td>The same as the <c>DbxDataType</c> column. <br> Reserved for .NET applications.</td></tr>
    ///  </table>
    /// </remarks>
    const DataTypes = 1;
    ...
    ///  <table cellspacing=0 cellpadding=4 border=1>
    ///    <tr><th align="left">Column&nbsp;Name</th><th align="left">Data&nbsp;Type</th><th align="left">Description</th></tr>
    ///    <tr><td>CatalogName</td><td>String</td><td>The catalog name.</td></tr>
    ///  </table>
    /// </summary>
    const Catalogs = 2;
    ...
    ///    <tr><th align="left">Column&nbsp;Name</th><th align="left">Data&nbsp;Type</th><th align="left">Description</th></tr>
    ///    <tr><td>CatalogName</td><td>String</td><td>The catalog name.</td></tr>
    ///    <tr><td>SchemaName</td><td>String</td><td>The schema name.</td></tr>
    ///  </table>
    /// </summary>
    const Schemas = 3;
    ...
    ///    <tr><td>CatalogName</td><td>String</td><td>The catalog name.</td></tr>
    ///    <tr><td>SchemaName</td><td>String</td><td>The schema name.</td></tr>
    ///    <tr><td>TableName</td><td>String</td><td>The table name.</td></tr>
    ///    <tr><td>TableType</td><td>String</td><td>The table type: TABLE, VIEW, SYNONYM, SYSTEM_TABLE.</td></tr>
    ///  </table>
    /// </summary>
    const Tables = 4;
    ...
    ///    <tr><td>CatalogName</td><td>String</td><td>The catalog name.</td></tr>
    ///    <tr><td>SchemaName</td><td>String</td><td>The schema name.</td></tr>
    ///    <tr><td>ViewName</td><td>String</td><td>The view name.</td></tr>
    ///    <tr><td>Definition</td><td>String</td><td>The SQL which was used to create the view.</td></tr>
    ///  </table>
    /// </summary>
    const Views = 5;
    ...
    ///    <tr><td>CatalogName</td><td>String</td><td>The catalog name.</td></tr>
    ///    <tr><td>SchemaName</td><td>String</td><td>The schema name.</td></tr>
    ///    <tr><td>SynonymName</td><td>String</td><td>The synonym name.</td></tr>
    ///    <tr><td>TableCatalogName</td><td>String</td><td>The catalog name of the table this synonym refers to.</td></tr>
    ///    <tr><td>TableSchemaName</td><td>String</td><td>The schema name of the table this synonym refers to.</td></tr>
    ///    <tr><td>TableName</td><td>String</td><td>The name of the table this synonym refers to.</td></tr>
    ///  </table>
    /// </summary>
    const Synonyms = 6;
    ...
    ///    <tr><td>SchemaName</td><td>String</td><td>The schema name.</td></tr>
    ///    <tr><td>TableName</td><td>String</td><td>The table name.</td></tr>
    ///    <tr><td>ColumnName</td><td>String</td><td>The column name.</td></tr>
    ///    <tr><td>TypeName</td><td>String</td><td>The database specific data type name.</td></tr>
    ///    <tr><td>Precision</td><td>Int32</td><td>The precision of this type.
    /// </summary>
    /// <remarks> <br> For a string data type, this is the maximum number of characters. <br> For a decimal types, this is the maximum number digits including digits from the scale.</td></tr>
    ///    <tr><td>Scale</td><td>Int32</td><td>The scale of a decimal type.</td></tr>
    ///    <tr><td>Ordinal</td><td>Int32</td><td>The position in the columns of the table starting with 1.</td></tr>
    ///    <tr><td>DefaultValue</td><td>String</td><td>The default value.</td></tr>
    ///    <tr><td>IsNullable</td><td>Boolean</td><td>Can accept NULL values.</td></tr>
    ///    <tr><td>IsAutoIncrement</td><td>Boolean</td><td>Is an autoincrement value.</td></tr>
    ///    <tr><td>MaxInline</td><td>Int32</td><td>The maximal number of bytes to write into row. The rest of the data is handled as a blob (BlackfishSQL only).</td></tr>
    ///    <tr><td>DbxDataType</td><td>Int32</td><td>The DBX data type.</td></tr>
    ///    <tr><td>IsFixedLength</td><td>Boolean</td><td>Holds fixed length data.</td></tr>
    ///    <tr><td>IsUnicode</td><td>Boolean</td><td>Can hold unicode characters.</td></tr>
    ///    <tr><td>IsLong</td><td>Boolean</td><td>Is a blob data type.</td></tr>
    ///    <tr><td>IsUnsigned</td><td>Boolean</td><td>Is an unsigned numeric type.</td></tr>
    ///  </table>
    /// </remarks>
    const Columns = 7;
    ...
    ///    <tr><td>SchemaName</td><td>String</td><td>The schema name.</td></tr>
    ///    <tr><td>TableName</td><td>String</td><td>The table name.</td></tr>
    ///    <tr><td>ConstraintName</td><td>String</td><td>The constraint name.</td></tr>
    ///    <tr><td>ColumnName</td><td>String</td><td>The column name.</td></tr>
    ///  </table>
    /// </summary>
    ...
    ///    <tr><td>SchemaName</td><td>String</td><td>The schema name.</td></tr>
    ///    <tr><td>TableName</td><td>String</td><td>The table name.</td></tr>
    ///    <tr><td>IndexName</td><td>String</td><td>The index name.</td></tr>
    ///    <tr><td>ConstraintName</td><td>String</td><td>The constraint name, may be NULL.</td></tr>
    ///    <tr><td>IsPrimary</td><td>Boolean</td><td>Is the primary key of the table.</td></tr>
    ///    <tr><td>IsUnique</td><td>Boolean</td><td>Is an unique index of the table.</td></tr>
    ///    <tr><td>IsAscending</td><td>Boolean</td><td>Is a descending index (Interbase only).</td></tr>
    ///  </table>
    /// </summary>
    const Indexes = 9;
    ...
    ///    <tr><td>TableName</td><td>String</td><td>The table name.</td></tr>
    ///    <tr><td>IndexName</td><td>String</td><td>The index name.</td></tr>
    ///    <tr><td>ColumnName</td><td>String</td><td>A column in the index.</td></tr>
    ///    <tr><td>Ordinal</td><td>Int32</td><td>The position of the column in the index starting with 1.</td></tr>
    ///    <tr><td>IsAscending</td><td>Boolean</td><td>Is a descending index column.</td></tr>
    ///  </table>
    /// </summary>
    ...
    ///    <tr><td>SchemaName</td><td>String</td><td>The schema name.</td></tr>
    ///    <tr><td>TableName</td><td>String</td><td>The table name.</td></tr>
    ///    <tr><td>ForeignKeyName</td><td>String</td><td>The foreign key name.</td></tr>
    ///  </table>
    /// </summary>
    ...
    ///  <table cellspacing=0 cellpadding=4 border=1>
    ///    <tr><th align="left">Column&nbsp;Name</th><th align="left">Data&nbsp;Type</th><th align="left">Description</th></tr>
    ///    <tr><td>CatalogName</td><td>String</td><td>The catalog name of the table with the foreign key.</td></tr>
    ///    <tr><td>SchemaName</td><td>String</td><td>The schema name of the table with the foreign key.</td></tr>
    ///    <tr><td>TableName</td><td>String</td><td>The name of the table with the foreign key.</td></tr>
    ///    <tr><td>ForeignKeyName</td><td>String</td><td>The foreign key name.</td></tr>
    ///    <tr><td>ColumnName</td><td>String</td><td>A column which refers to a column of in another table.</td></tr>
    ///    <tr><td>PrimaryCatalogName</td><td>String</td><td>The catalog name of the table being referred to.</td></tr>
    ///    <tr><td>PrimarySchemaName</td><td>String</td><td>The schema name of the table being referred to.</td></tr>
    ///    <tr><td>PrimaryTableName</td><td>String</td><td>The name of the table being referred to.</td></tr>
    ///    <tr><td>PrimaryKeyName</td><td>String</td><td>The name of the key being referred to.
    /// </summary>
    /// <remarks> <br> This is usually the primary key.</td></tr>
    ///    <tr><td>PrimaryColumnName</td><td>String</td><td>The column which is being referred to.</td></tr>
    ///    <tr><td>Ordinal</td><td>Int32</td><td>The position of the column reference in the foreign key.</td></tr>
    ///  </table>
    /// </remarks>
    ...
    ///    <tr><td>CatalogName</td><td>String</td><td>The catalog name.</td></tr>
    ///    <tr><td>SchemaName</td><td>String</td><td>The schema name.</td></tr>
    ///    <tr><td>ProcedureName</td><td>String</td><td>The procedure name.</td></tr>
    ///    <tr><td>ProcedureType</td><td>String</td><td>The procedure type: FUNCTION or PROCEDURE.</td></tr>
    ///  </table>
    /// </summary>
    const Procedures = 13;
    ...
    ///    <tr><td>ProcedureName</td><td>String</td><td>The procedure name.</td></tr>
    ///    <tr><td>ProcedureType</td><td>String</td><td>The procedure type: FUNCTION or PROCEDURE.</td></tr>
    ///    <tr><td>Definition</td><td>String</td><td>The source of the SQL procedure.</td></tr>
    ///    <tr><td>ExternalDefinition</td><td>String</td><td>A reference to an procedure external to the database.</td></tr>
    ///  </table>
    /// </summary>
    ...
    ///    <tr><td>SchemaName</td><td>String</td><td>The schema name.</td></tr>
    ///    <tr><td>ProcedureName</td><td>String</td><td>The procedure name.</td></tr>
    ///    <tr><td>ParameterName</td><td>String</td><td>The parameter name.</td></tr>
    ///    <tr><td>ParameterMode</td><td>String</td><td>The parameter mode: IN, OUT, INOUT, RESULT.</td></tr>
    ///    <tr><td>TypeName</td><td>String</td><td>The database specific data type name.</td></tr>
    ///    <tr><td>Precision</td><td>Int32</td><td>The precision of this type.
    /// </summary>
    /// <remarks> <br> For a string data type, this is the maximum number of characters. <br> For a decimal types, this is the maximum number digits including digits from the scale.</td></tr>
    ///    <tr><td>Scale</td><td>Int32</td><td>The scale of a decimal type.</td></tr>
    ///    <tr><td>Ordinal</td><td>Int32</td><td>The position in the rows of the table starting with 1.</td></tr>
    ///    <tr><td>IsNullable</td><td>Boolean</td><td>Can accept NULL values.</td></tr>
    ///    <tr><td>DbxDataType</td><td>Int32</td><td>The DBX data type.</td></tr>
    ///    <tr><td>IsFixedLength</td><td>Boolean</td><td>Holds fixed length data.</td></tr>
    ///    <tr><td>IsUnicode</td><td>Boolean</td><td>Can hold unicode characters.</td></tr>
    ///    <tr><td>IsLong</td><td>Boolean</td><td>Is blob data type.</td></tr>
    ///    <tr><td>IsUnsigned</td><td>Boolean</td><td>Is unsigned numeric type.</td></tr>
    ///  </table>
    /// </remarks>
    ...
    ///    <tr><td>CatalogName</td><td>String</td><td>The catalog name.</td></tr>
    ///    <tr><td>SchemaName</td><td>String</td><td>The schema name.</td></tr>
    ///    <tr><td>PackageName</td><td>String</td><td>The package name.</td></tr>
    ///  </table>
    /// </summary>
    const Packages = 16;
    ...
    ///    <tr><td>SchemaName</td><td>String</td><td>The schema name.</td></tr>
    ///    <tr><td>PackageName</td><td>String</td><td>The package name.</td></tr>
    ///    <tr><td>ProcedureName</td><td>String</td><td>The procedure name from the package.</td></tr>
    ///    <tr><td>ProcedureType</td><td>String</td><td>The procedure type: FUNCTION, PROCEDURE.</td></tr>
    ///  </table>
    /// </summary>
    ...
    ///    <tr><td>SchemaName</td><td>String</td><td>The schema name.</td></tr>
    ///    <tr><td>PackageName</td><td>String</td><td>The package name.</td></tr>
    ///    <tr><td>Definition</td><td>String</td><td>The package source code.</td></tr>
    ///  </table>
    /// </summary>
    ...
    ///  <table cellspacing=0 cellpadding=4 border=1>
    ///    <tr><th align="left">Column&nbsp;Name</th><th align="left">Data&nbsp;Type</th><th align="left">Description</th></tr>
    ///    <tr><td>UserName</td><td>String</td><td>A user name.</td></tr>
    ///  </table>
    /// </summary>
    const Users = 20;
    ...
    ///  <table cellspacing=0 cellpadding=4 border=1>
    ///    <tr><th align="left">Column&nbsp;Name</th><th align="left">Data&nbsp;Type</th><th align="left">Description</th></tr>
    ///    <tr><td>RoleName</td><td>String</td><td>A role name.</td></tr>
    ///  </table>
    /// </summary>
    const Roles = 21;
    ...
    ///  <table cellspacing=0 cellpadding=4 border=1>
    ///    <tr><th align="left">Column&nbsp;Name</th><th align="left">Data&nbsp;Type</th><th align="left">Description</th></tr>
    ///    <tr><td>ReservedWord</td><td>String</td><td>An identifier reserved for the SQL syntax.
    /// </summary>
    /// <remarks> <br> These identifiers should not be used as object names such as tables and columns. Some databases allows their use if they are quoted.</td></tr>
    ///  </table>
    /// </remarks>
  ...
  public
    ...
    ///   and columns. Some databases allows their use if they are quoted.</p>
    /// </remarks>
