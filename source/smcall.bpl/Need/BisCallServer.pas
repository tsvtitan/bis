...
begin
  ...
  FSLineFormat:='%s: %s';
  FSCommand:='Команда %s';
  FSCommandError:='Команда %s выполнена с ошибкой: %s';
  FSIncomingCall:='входящий вызов';
  FSOutgoingCall:='исходящий вызов';
  FSPlayGreetingStart:='Музыка приветствия ...';
  FSPlayHoldingStart:='Музыка удержания ...';
  FSPlayNotfoundStart:='Музыка нет принимающих ...';
  FSPlayConfirmStart:='Музыка правильного кода сообщения ...';
  FSPlayWrongStart:='Музыка неправильного кода сообщения ...';
  FSAcceptorDial:='Дозвон до %s (%s)';
  FSSearchStart:='Начало поиска ...';

  FSChannelCheckStart:='Начало проверки (%s) ...';
  FSChannelCheckFail:='Проверка не прошла. %s';
  FSChannelRingStart:='Звонок ...';
  FSChannelRingFail:='Звонок не прошел. %s';
  FSChannelCancelStart:='Отмена ...';
  FSChannelCancelFail:='Отмена не прошла. %s';
  FSChannelConnectStart:='Подключение ...';
  FSChannelConnectFail:='Подключение не прошла. %s';
  FSChannelDisconnectStart:='Отключение ...';
  FSChannelDisconnectFail:='Отключение не прошло. %s';
  FSChannelCodeStart:='Код сообщения ...';
  FSChannelCodeFail:='Код сообщения не прошел. %s';
  FSChannelHoldStart:='Удержание ...';
  FSChannelHoldFail:='Удержание не прошло. %s';
  FSChannelUnHoldStart:='Снятие удержания ...';
  FSChannelUnHoldFail:='Снятие удержания не прошло. %s';
  FSChannelPlayBeginStart:='Начало музыки ...';
  FSChannelPlayBeginFail:='Начало музыки не прошло. %s';
  FSChannelPlayEndStart:='Окончание музыки ...';
  FSChannelPlayEndFail:='Окончание музыки не прошло. %s';
  FSChannelError:='%s';
  FSChannelTimeOutStart:='Время истекло ...';
  FSChannelTimeOutFail:='Время истекло не прошло. %s';
  FSChannelDataStart:='Данные ...';
  FSChannelDataFail:='Данные не прошли. %s';
