...
uses
  ...
  ExtCtrls, ComCtrls, ACS_WinMedia, ACS_smpeg, ACS_Misc, ACS_Streams, NewACDSAudio, AuASIO;
...
begin
  ...
  if DSAudioOut1.Status = tosPlaying then DSAudioOut1.Stop;
