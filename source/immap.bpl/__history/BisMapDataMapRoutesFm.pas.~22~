...
begin
  ...
  with FieldNames do begin
    ...
    Add('FROM_STREET_NAME','Улица из',120);
    Add('FROM_HOUSE','Дом из',50).IsKey:=true;
    Add('FROM_LOCALITY_NAME','Населенный пункт из',95);

    Add('TO_STREET_NAME','Улица в',120);
    Add('TO_HOUSE','Дом в',50).IsKey:=true;
    Add('TO_LOCALITY_NAME','Населенный пункт в',95);

    Add('DISTANCE','Расстояние (м)',80);
    Add('DURATION','Время (сек)',50);
  end;
