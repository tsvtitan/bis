    ...
    begin
      ...
      begin
        case AKind of
          stmtDDL, stmtDML:
          begin
            IBAlloc(FBatchBuffer, FBatchCount * Sizeof(PChar),
              (FBatchCount + 1) * Sizeof(PChar));
            IBAlloc(P, 0, Length(SQLText) + 1);
            Move(SQLText[1], P^, Length(SQLText));
            Buffer := FBatchBuffer;
          ...
          begin
            ...
            try
              ...
              Database.Call(GetGDSLibrary.isc_dsql_batch_execute_immed(StatusVector,
