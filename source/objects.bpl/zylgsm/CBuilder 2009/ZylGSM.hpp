...
// (DO NOT EDIT: machine generated header) 'Zylgsm.pas' rev: 20.00
...
typedef void __fastcall (__closure *TRingEvent)(System::TObject* Sender, System::AnsiString CallerNumber);

typedef void __fastcall (__closure *TNewMessageEvent)(System::TObject* Sender, System::AnsiString Location, int Index);

typedef void __fastcall (__closure *TReadMessageEvent)(System::TObject* Sender, System::AnsiString MessageText, System::AnsiString PhoneNumber, System::AnsiString CenterNumber, int Status);
...
private:
	...
	void __fastcall HandleGSMEvents(System::AnsiString strAT);
	System::AnsiString __fastcall SafeCopy(const System::AnsiString strText, int nStart, int nLength, const System::AnsiString DefaultValue);
	bool __fastcall RunningInTheIDE(void);
	
protected:
	System::AnsiString __fastcall StringToPDU(System::AnsiString str);
	TPDUSMS __fastcall StringToPDUSMS(System::AnsiString PhoneNumber, System::AnsiString CenterNumber, System::AnsiString MessageText);
...
public:
	...
	System::AnsiString __fastcall PDUToString(System::AnsiString str);
	System::AnsiString __fastcall PDUSMSToString(System::AnsiString MessageText, System::AnsiString &PhoneNumber, System::AnsiString &CenterNumber);
	...
	TCommPort __fastcall StringToCommPort(const System::AnsiString Port);
	...
	void __fastcall DialData(System::AnsiString PhoneNumber);
	void __fastcall DialVoice(System::AnsiString PhoneNumber);
	void __fastcall AnswerCall(void);
	void __fastcall TerminateCall(void);
	void __fastcall SendSmsAsText(System::AnsiString PhoneNumber, System::AnsiString CenterNumber, System::AnsiString MessageText);
	void __fastcall SendSmsAsPDU(System::AnsiString PhoneNumber, System::AnsiString CenterNumber, System::AnsiString MessageText);
	void __fastcall DeleteSMS(System::AnsiString Location, int Index);
	void __fastcall GetSMS(System::AnsiString Location, int Index);
...
#define Phone_SIM L"SM"
#define Phone_MEMORY L"ME"
#define sCannotConnect L"Cannot connect to %s . %s"
