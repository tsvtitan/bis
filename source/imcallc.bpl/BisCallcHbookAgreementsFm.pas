...
begin
  ...
  InsertClasses.Add(TBisCallcHbookAgreementInsertFormIface);
  InsertClasses.Add(TBisCallcHbookAgreementInsertChildFormIface);
  ...
  with FieldNames do begin
    ...
    Add('NUM','Номер',120);
    Add('FIRM_SMALL_NAME','Организация',200);
    Add('DATE_BEGIN','Дата начала',75);
    Add('DATE_END','Дата окончания',75);
    Add('PARENT_NUM','Родитель',80);
  end;
end;
