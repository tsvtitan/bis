...
constructor TSendDlg.Create(AOwner: TComponent);
var
  Num: Integer;
  i: Integer;
...
begin
  ...
  if Assigned(Info) then begin
    with Info.Form.ListBoxFormats do begin
      S:=Format('Index=%d Tag=%d TagName=%s Support=%d Size=%d Format=%s SamplesPerSec=%d '+
                'AvgBytesPerSec=%d BlockAlign=%d BitsPerSample=%d',
                [pafd.dwFormatIndex,pafd.dwFormatTag,Info.FormatTagDetails.szFormatTag,pafd.fdwSupport,
                 SizeOf(pafd.pwfx^)+pafd.pwfx.cbSize,pafd.szFormat,pafd.pwfx.nSamplesPerSec,
                 pafd.pwfx.nAvgBytesPerSec,pafd.pwfx.nBlockAlign,pafd.pwfx.wBitsPerSample]);
...
procedure TSendDlg.ListBoxDriversClick(Sender: TObject);
var
  Index: Integer;
  Obj: TAcmDriver;
...
function TSendDlg.GetDeviceID: HWaveOut;
var
  Index: Integer;
begin
...
function TSendDlg.GetWaveFormatEx: PWaveFormatEx;
var
  Index: Integer;
  Obj: TAcmFormat;
begin
...
function TSendDlg.GetWaveFormatSize: Integer;
var
  Index: Integer;
  Obj: TAcmFormat;
begin
...
begin
  ...
  try
    if Dlg.Execute then begin
      CopyMemory(Fwfx,Dlg.WaveFormatEx,Dlg.WaveFormatSize);
