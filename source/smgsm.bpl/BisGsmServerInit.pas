...
begin
  ...
  FSDeleteMessageSuccess:='Входящее сообщение удалено успешно.';
  FSDeleteMessageFail:='Входящее сообщение не удалено.';
  ...
  FSOutMessageSendFail:='Исходящее сообщение не отправлено. %s';
