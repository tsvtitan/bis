...
uses DateUtils,
     BisUtils,
     BisCore,
     BisCallResultFm, BisTaxiDataBlackEditFm, BisTaxiOrdersFm, BisTaxiOrdersFrm,
     BisTaxiOrderEditFm;
...
procedure TBisTaxiPhoneFrame.SetCallLineName(const Value: String);
begin
...
begin
  if LabelDescription.Visible or (CallKind<>pckUnknown)  then begin
    Height:=40;
  end else begin
    Height:=20;
  end;
...
function TBisTaxiPhoneFrame.GetCallNameDescription: String;
begin
...
procedure TBisTaxiPhoneFrame.ResizeControls;
begin
  ...
  ImageGroup.Left:=LabelDescription.Left+LabelDescription.Width+Delta*2;
  LabelGroup.Left:=ImageGroup.Left+ImageGroup.Width+Delta;
...
procedure TBisTaxiPhoneFrame.SetCallNameDescription(const Value: String);
begin
...
function TBisTaxiPhoneFrame.GetCallLineName: String;
begin
