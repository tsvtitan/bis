  ...
  begin
    ...
    begin
      ...
      try
        ...
        try
          // by TSV
          if Success(WaveOutOpen(nil, DeviceID, pWaveFormat, 0, 0, WAVE_FORMAT_QUERY or WAVE_MAPPED)) then
...
begin
  // by TSV
  Result := (WaveOutOpen(nil, DeviceID, pWaveFormat, 0, 0, WAVE_FORMAT_QUERY or WAVE_MAPPED) = MMSYSERR_NOERROR);
//  Result := (WaveOutOpen(nil, DeviceID, pWaveFormat, 0, 0, WAVE_FORMAT_QUERY) = MMSYSERR_NOERROR);
end;
