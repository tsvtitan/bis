...
type
  ...
  public
    ...
    property SMSC: String read GeTGsmSmsC;
...
function TGsmSms.DecodeNumber(raw: String): String;
var
  addrType: Integer;
begin
  try
...
function TGsmSms.EncodeNumber(Number: String): String;
begin
  Result := '81';
...
function TGsmSms.Get7bit(str: String): String;
var
  i, j, x: Integer;
  leftover, octet: byte;
  c: string[2];
...
function TGsmSms.Get8bit(str: String): String;
var
  i: Integer;
  octet: Integer;
begin
...
function TGsmSms.GetUCS2(str: String): WideString;
var
  i: Integer;
  octet: Integer;
begin
...
function TGsmSms.GetMessage: WideString;
var
  startpos: Integer;
  str, UDHnull: String;
...
function TGsmSms.GetPDU: String;
var
  udhl: Integer;
  i, j, x, head: Integer;
  Octet: String;
...
function TGsmSms.ReverseOctets(Octets: String): String;
var
  i: Integer;
  buffer: char;
begin
...
procedure TGsmSms.SetPDU(const Value: String);
var
  PDUType, TPVPF: Byte;
  TPDCS: Integer;
  Offset: Integer;
...
function TGsmSms.MakeCRLF(str: string): String;
var
  i: Integer;
  skipnext: boolean;
begin
...
begin
  ...
  if str8bit <> str then
    ...
    for i := 1 to length(str8bit) do begin
      ...
      if ForceUCSusage or (DoStrictUCScheck and (str8bit[i] in ['À'..'ß','à'..'ÿ'])) then begin
        Result := 2;
        break;
      end;
...
procedure TGsmSms.Set_MessageRef(const Value: String);
begin
  FMessageRef := Copy(Value,1,2);
  while Length(FMessageRef) < 2 do FMessageRef := '0' + FMessageRef;
end;

function TGsmSms.GetNewPDU(AMessageReference: String): String;
begin
