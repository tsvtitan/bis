...
unit DBXInterbaseMetaDataReader;
interface
uses
  DBXMetaDataNames,
  DBXMetaDataReader,
...
type
  ...
  /// <summary>  InterbaseCustomMetaDataProvider contains custom code for Interbase.
  /// </summary>
  ...
  public
    type
      ...
      /// <summary>  InterbaseTypeFilterCursor is a filter for a cursor providing table columns and procedure parameters.
      /// </summary>
      ...
      ///   This filter also normalizes the default value.
      /// </remarks>
      TDBXInterbaseTypeFilterCursor = class(TDBXBaseMetaDataReader.TDBXSanitizedTableCursor)
      public
        type
      ...
      protected
        ...
        /// <summary> Constructor for InterbaseTypeFilterCursor.
        /// </summary>
        ...
        constructor Create(const Provider: TDBXInterbaseCustomMetaDataReader; const MetadataCollectionIndex: Integer; const MetadataCollectionName: WideString; const Columns: TDBXColumnDescriptorArray; const Cursor: TDBXTableStorage; const OrdinalTypeName: Integer; const OrdinalFieldType: Integer; const OrdinalSubType: Integer; const OrdinalScale: Integer; const OrdinalDefaultValue: Integer);
  ...
  public
    ...
    /// </remarks>
    /// <seealso cref="InterbaseTypeFilterCursor."/>
...
function TDBXInterbaseCustomMetaDataReader.GetSqlIdentifierQuotePrefix: WideString;
begin
  Result := FQuoteChar;
end;

function TDBXInterbaseCustomMetaDataReader.GetSqlIdentifierQuoteSuffix: WideString;
begin
  Result := FQuoteChar;
end;

function TDBXInterbaseCustomMetaDataReader.GetSqlIdentifierQuoteChar: WideString;
begin
  Result := FQuoteChar;
end;
...
function TDBXInterbaseCustomMetaDataReader.FetchColumns(const Catalog: WideString; const Schema: WideString; const Table: WideString): TDBXTableStorage;
var
...
begin
  ...
  Result := TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.Create(self, TDBXMetaDataCollectionIndex.Columns, TDBXMetaDataCollectionName.Columns, Columns, Cursor, TDBXColumnsIndex.TypeName, ColumnsFieldType, ColumnsSubtype, TDBXColumnsIndex.Scale, TDBXColumnsIndex.DefaultValue);
end;

function TDBXInterbaseCustomMetaDataReader.FetchProcedureParameters(const Catalog: WideString; const Schema: WideString; const &Procedure: WideString; const Parameter: WideString): TDBXTableStorage;
var
  ParameterNames: TDBXWideStringArray;
  ParameterValues: TDBXWideStringArray;
  Cursor: TDBXTableStorage;
...
begin
  ...
  Result := TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.Create(self, TDBXMetaDataCollectionIndex.ProcedureParameters, TDBXMetaDataCollectionName.ProcedureParameters, Columns, Cursor, TDBXProcedureParametersIndex.TypeName, ParametersFieldType, ParametersSubtype, TDBXProcedureParametersIndex.Scale, -1);
end;

constructor TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.Create(const Provider: TDBXInterbaseCustomMetaDataReader; const MetadataCollectionIndex: Integer; const MetadataCollectionName: WideString; const Columns: TDBXColumnDescriptorArray; const Cursor: TDBXTableStorage; const OrdinalTypeName: Integer; const OrdinalFieldType: Integer; const OrdinalSubType: Integer; const OrdinalScale: Integer; const OrdinalDefaultValue: Integer);
begin
...
function TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.FindStringSize(const Ordinal: Integer; const SourceColumns: TDBXColumnDescriptorArray): Integer;
begin
...
function TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.Next: Boolean;
begin
  FDataType := nil;
...
function TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.IsNull(Ordinal: Integer): Boolean;
begin
...
function TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.GetString(Ordinal: Integer): WideString;
begin
  if Ordinal = FOrdinalTypeName then
...
function TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.GetInt32(Ordinal: Integer): Integer;
begin
...
function TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.GetBoolean(Ordinal: Integer): Boolean;
begin
...
procedure TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.ComputeDataType;
var
  FieldType: SmallInt;
  SubType: SmallInt;
  Scale: SmallInt;
...
function TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.ComputeTypeName: WideString;
var
  SubType: SmallInt;
begin
...
function TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.ComputeUnicode: Boolean;
var
  CharSet: SmallInt;
begin
...
function TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.ComputeDefaultValue: WideString;
var
...
function TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.GetIBType(FieldType: SmallInt; FieldSubType: SmallInt; FieldScale: SmallInt): Integer;
begin
// CJL-IB6 -- Decimal/int64 types possible
  if FieldScale < 0 then
    case FieldType of
      TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.TDBXibase_const.FBlr_short:
        begin
          Result := NumericType;
          exit;
        end;
      TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.TDBXibase_const.FBlr_long:
      ...
      TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.TDBXibase_const.FBlr_int64:
        if FieldSubType = 2 then
        begin
          Result := DecimalType;
          exit;
      ...
      TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.TDBXibase_const.FBlr_double:
        begin
          Result := NumericType;
          exit;
        end;
...
// CJL-IB6 -- end
  case FieldType of
    ...
    TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.TDBXibase_const.FBlr_long:
      Result := IntegerType;
    TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.TDBXibase_const.FBlr_double,
    TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.TDBXibase_const.FBlr_d_float:
      Result := DoubleType;
    TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.TDBXibase_const.FBlr_float:
      Result := FloatType;
    TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.TDBXibase_const.FBlr_text:
      Result := CharType;
    TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.TDBXibase_const.FBlr_varying:
      Result := VarcharType;
    TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.TDBXibase_const.FBlr_timestamp:
      Result := TimestampType;
    TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.TDBXibase_const.FBlr_sql_time:
      Result := TimeType;
    TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.TDBXibase_const.FBlr_sql_date:
      Result := DateType;
    TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.TDBXibase_const.FBlr_int64:
      if FieldSubType = 2 then
        Result := DecimalType
    ...
    9:
      Result := -1;
    TDBXInterbaseCustomMetaDataReader.TDBXInterbaseTypeFilterCursor.TDBXibase_const.FBlr_boolean_dtype:
      Result := BooleanType;
    else
      Result := -1;
  end;
...
function TDBXInterbaseMetaDataReader.GetProductName: WideString;
begin
  Result := 'InterBase';
end;
...
function TDBXInterbaseMetaDataReader.FetchCatalogs: TDBXTableStorage;
var
  Columns: TDBXColumnDescriptorArray;
begin
...
function TDBXInterbaseMetaDataReader.FetchSchemas(const CatalogName: WideString): TDBXTableStorage;
var
  Columns: TDBXColumnDescriptorArray;
begin
...
function TDBXInterbaseMetaDataReader.GetSqlForTables: WideString;
begin
...
function TDBXInterbaseMetaDataReader.GetSqlForViews: WideString;
begin
...
function TDBXInterbaseMetaDataReader.GetSqlForColumns: WideString;
begin
...
function TDBXInterbaseMetaDataReader.FetchColumnConstraints(const CatalogName: WideString; const SchemaName: WideString; const TableName: WideString): TDBXTableStorage;
var
  Columns: TDBXColumnDescriptorArray;
begin
...
function TDBXInterbaseMetaDataReader.GetSqlForIndexes: WideString;
begin
...
function TDBXInterbaseMetaDataReader.GetSqlForIndexColumns: WideString;
begin
...
function TDBXInterbaseMetaDataReader.GetSqlForForeignKeys: WideString;
begin
...
function TDBXInterbaseMetaDataReader.GetSqlForForeignKeyColumns: WideString;
begin
...
function TDBXInterbaseMetaDataReader.FetchSynonyms(const CatalogName: WideString; const SchemaName: WideString; const SynonymName: WideString): TDBXTableStorage;
var
  Columns: TDBXColumnDescriptorArray;
begin
...
function TDBXInterbaseMetaDataReader.GetSqlForProcedures: WideString;
begin
...
function TDBXInterbaseMetaDataReader.GetSqlForProcedureSources: WideString;
begin
...
function TDBXInterbaseMetaDataReader.GetSqlForProcedureParameters: WideString;
begin
...
function TDBXInterbaseMetaDataReader.FetchPackages(const CatalogName: WideString; const SchemaName: WideString; const PackageName: WideString): TDBXTableStorage;
var
  Columns: TDBXColumnDescriptorArray;
begin
...
function TDBXInterbaseMetaDataReader.FetchPackageProcedures(const CatalogName: WideString; const SchemaName: WideString; const PackageName: WideString; const ProcedureName: WideString; const ProcedureType: WideString): TDBXTableStorage;
var
  Columns: TDBXColumnDescriptorArray;
begin
...
function TDBXInterbaseMetaDataReader.FetchPackageProcedureParameters(const CatalogName: WideString; const SchemaName: WideString; const PackageName: WideString; const ProcedureName: WideString; const ParameterName: WideString): TDBXTableStorage;
var
  Columns: TDBXColumnDescriptorArray;
begin
...
function TDBXInterbaseMetaDataReader.FetchPackageSources(const CatalogName: WideString; const SchemaName: WideString; const PackageName: WideString): TDBXTableStorage;
var
  Columns: TDBXColumnDescriptorArray;
begin
...
function TDBXInterbaseMetaDataReader.GetSqlForUsers: WideString;
begin
  Result := 'SELECT RDB$USER_NAME FROM RDB$USERS ORDER BY 1';
end;

function TDBXInterbaseMetaDataReader.GetSqlForRoles: WideString;
begin
  Result := 'SELECT RDB$ROLE_NAME FROM RDB$ROLES ORDER BY 1';
end;

function TDBXInterbaseMetaDataReader.GetReservedWords: TDBXWideStringArray;
var
