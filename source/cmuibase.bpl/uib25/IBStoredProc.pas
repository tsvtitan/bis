...
procedure TIBStoredProc.PSSetCommandText(const CommandText: WideString);
begin
  if CommandText <> '' then
...
function TIBStoredProc.PSGetTableNameW: WideString;
begin
  { ! }
end;
...
function TIBStoredProc.PSGetCommandTextW: WideString;
begin
