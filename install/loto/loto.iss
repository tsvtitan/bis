...
[Components]
Name: client; Description: Лото на Енисее 1.0.0.120; Types: full
...
[Run]
Filename: {tmp}\Firebird-1.5.6.5026-0-Win32.exe; Parameters: /silent; WorkingDir: {tmp}; StatusMsg: Установка Firebird и настройка соединения ...; Flags: runhidden; Components: firebird
