...
uses
  Windows, MMSystem, _DXTypes;

(*==========================================================================;
 *
 *  Copyright (c) Microsoft Corporation.  All rights reserved.
 *
 *  DirectSound include file
 *
 **************************************************************************)
...
type
  ...
  TD3DColor = _DXTypes.TD3DColor;

  _D3DVECTOR = _DXTypes._D3DVECTOR;
  {$EXTERNALSYM _D3DVECTOR}
  D3DVECTOR = _DXTypes.D3DVECTOR;
...
type
  REFERENCE_TIME = _DXTypes.REFERENCE_TIME;
