...
begin
  ...
  with FieldNames do begin
    ...
    Add('POSITION_PRIORITY','Позиция',40);
    Add('DOC_FULL_NAME','Документ',200);
    Add('DATE_ISSUE','Дата передачи',110);
    Add('USER_NAME','Пользователь',120);
    Add('DATE_PROCESS','Дата выполнения',110);
  end;
