...
uses BisUtils, BisCore, BisFilterGroups, BisTaxiConsts, BisParamEditDataSelect,
     BisProvider, BisIfaces, BisDataSet, BisTaxiDataPatternMessagesFm,
...
begin
  ...
  with Params do begin
    ...
    with AddEditDataSelect('RECIPIENT_ID','EditRecipient','LabelRecipient','ButtonRecipient',
                           SClassDataAccountsFormIface,'RECIPIENT_USER_NAME;RECIPIENT_SURNAME;RECIPIENT_NAME;RECIPIENT_PATRONYMIC',
