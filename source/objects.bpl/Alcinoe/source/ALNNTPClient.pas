...
begin
  aStatutCode := GetStatusCodeFromResponse(SendCmd('NEXT',[223,421], False)); //223 10113 <21495@nudebch.uucp> article retrieved - request text separately
...
Var aStatutCode: integer;
begin
  aStatutCode := GetStatusCodeFromResponse(SendCmd('LAST',[223, 422], False)); //223 10113 <21495@nudebch.uucp> article retrieved
  Result := aStatutCode=223;
end;
