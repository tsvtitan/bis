...
begin
  ...
  FSLineFormat:='%s: %s';
  FSScenarioStep:='Сценарий %s шаг = %s';
  ...
  FSChannelBusyStart:='Занято ...';
  FSChannelBusyFail:='Занято не прошло. %s';
  ...
  FSChannelCodeStart:='Код (%s) ...';
  FSChannelCodeFound:='Меню %s';
  FSChannelCodeFail:='Код не прошел. %s';
  ...
  FSChannelPlayStart:='Воиспроизведение музыки ...';
  FSChannelPlayFail:='Воиспроизведение музыки не прошло. %s';
  FSChannelStopStart:='Остановка музыки ...';
  FSChannelStopFail:='Остановка музыки не прошла. %s';
