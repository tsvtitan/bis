...
uses DateUtils,
     ...
     BisMessDataInMessageEditFm, BisMessDataInMessageFilterFm;
...
begin
  ...
  ViewClass:=TBisMessDataInMessageViewFormIface;
  ...
  with Provider do begin
    ...
    with FieldNames do begin
      ...
      AddCalculate('NEW_SENDER_NAME','Отправитель',GetNewSenderName,ftString,350,150);
    end;
...
function TBisMessDataInMessagesFrame.GetNewSenderName(FieldName: TBisFieldName; DataSet: TDataSet): Variant;
var
  S1, S2, S3, S4: String;
begin
  Result:=Null;
...
procedure TBisMessDataInMessagesFrame.BeforeIfaceExecute(AIface: TBisDataEditFormIface);
var
...
function TBisMessDataInMessagesFrame.CanUpdateRecord: Boolean;
begin
...
function TBisMessDataInMessagesFrame.CanDeleteRecord: Boolean;
begin
