...
type
  ...
  public
    ...
    property OriginalPDU: String read FOriginalPDU write FOriginalPDU; 
  end;
  ...
  public
    function Find(Index: Integer): TBisGsmModemMessage;
...
function TBisGsmModemMessages.Find(Index: Integer): TBisGsmModemMessage;
var
  i: Integer;
...
begin
  ...
  for i:=0 to Count-1 do begin
    Item:=Items[i];
    if Item.Index=Index then begin
      Result:=Item;
      exit;
    end;
  end;
      ...
      if Assigned(Message) then begin
        if CommandOk('AT+CMGF=0'#13) then begin // pdu mode
          ...
          try
            ...
            NewMessage.MessageReference:=Message.MessageReference;
