...
#define OutputBaseFilename "ball_"+AppVersion
...
Source: {#AppBin}\Firebird-2.5.0.26074_1_Win32.exe; DestDir: {tmp}; Flags: deleteafterinstall ignoreversion; Components: firebird
Source: {#AppBin}\ball.fdb; DestDir: {app}; Flags: confirmoverwrite uninsneveruninstall; Components: database
...
Source: {#AppBin}\tirage_001.xml; DestDir: {app}; Flags: ignoreversion; Components: tirage_001
