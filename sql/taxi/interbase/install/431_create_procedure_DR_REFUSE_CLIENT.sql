/* Создание процедуры определения результата клиент отказался */

CREATE PROCEDURE /*PREFIX*/DR_REFUSE_CLIENT
(
  ORDER_ID VARCHAR(32),
  ...
  IF (DRIVER_ID IS NOT NULL) THEN BEGIN
    ...
    SELECT COUNT(*)
     ...
     WHERE SENDER_ID=:DRIVER_ID
       AND CODE_MESSAGE_ID='0388BCC17DE1A1754B566F18AEEED771' /* Клиент отказался от заказа */
       AND TYPE_MESSAGE=0
