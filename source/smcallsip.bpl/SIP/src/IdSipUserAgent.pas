...
{    procedure OnFailure(RegisterAgent: TIdSipOutboundRegistrationBase;
  ...
  protected
    // by TSV
    procedure OnFailure(RegisterAgent: TIdSipOutboundRegistrationBase; ErrorCode: Cardinal; const Reason: String); virtual;
    procedure OnInboundCall(UserAgent: TIdSipInviteModule; Session: TIdSipInboundSession); virtual;
    procedure OnSuccess(RegisterAgent: TIdSipOutboundRegistrationBase; CurrentBindings: TIdSipContacts); virtual;
  public
...
procedure TIdSipUserAgent.OnFailure(RegisterAgent: TIdSipOutboundRegistrationBase; ErrorCode: Cardinal; const Reason: String);
begin

end;

procedure TIdSipUserAgent.OnInboundCall(UserAgent: TIdSipInviteModule; Session: TIdSipInboundSession);
begin
  // For now, do nothing.
end;

procedure TIdSipUserAgent.OnSuccess(RegisterAgent: TIdSipOutboundRegistrationBase; CurrentBindings: TIdSipContacts);
var
  Gruu: String;
begin
