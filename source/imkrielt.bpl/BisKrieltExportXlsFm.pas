  ...
  begin
    ...
    while not DataSet.Eof do begin
      ...
      if NewTown<>OldTown then begin
        ...
        Range.Value:=AnsiUpperCase(iff(VarSameValue(Field1.Value,GetNullValue(Field1)),'Без указания населенного пункта',NewTown));
      ...
      if NewDistrict<>OldDistrict then begin
        Inc(Row);
        Range:=Sheet.Cells[Row,1];
        Range.Value:=AnsiUpperCase(iff(VarSameValue(Field1.Value,GetNullValue(Field1)),'Без указания района',NewDistrict));
        Range:=Sheet.Range[Sheet.Cells[Row,1],Sheet.Cells[Row,7]];
      ...
      if NewStreetHouse<>OldStreetHouse then begin
        ...
        Range.Value:=iff(VarSameValue(Field1.Value,GetNullValue(Field1)),'[Без указания улицы]',NewStreetHouse);
  ...
  try
    ...
    try
      ...
      if PParams.Active and not PParams.Empty then begin
        ...
        Sortings.Add('E774322A3928ADC74A75A4E8815D6C4A'); // населенный пункт
        Sortings.Add('0538CA0399AB9FA9468D1A4741BA5090'); // район
        Sortings.Add('E7F33B7C110F96E240BC3C739F3172EB'); // улица
        Sortings.Add('251E5058A3518AA14A728599362FCE0B'); // номер дома
        Sortings.Add('CE659B2F7353BD004164E11CF5B84711'); // комнатность
