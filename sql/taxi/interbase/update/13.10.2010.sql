...
BEGIN
  ...
  IF (CONFIG_EXISTS(PARAMS,SECTION)=1) THEN BEGIN
    ...
    PORT=CONFIG_READ(PARAMS,SECTION,'Port','');
...
CREATE OR ALTER PROCEDURE EVENT_REFRESH_ORDER (
  APPLICATION_ID VARCHAR(32),
  ACCOUNT_ID VARCHAR(32),
  SESSION_ID VARCHAR(32),
  PROTOCOL INTEGER,
...
BEGIN
  SECTION='17DDE287AE4595B24A60812F57293B07';

  IN_PARAMS=CONFIG_WRITE(IN_PARAMS,SECTION,'OldOrderId',OLD_ORDER_ID);
  IN_PARAMS=CONFIG_WRITE(IN_PARAMS,SECTION,'NewOrderId',NEW_ORDER_ID);
  IN_PARAMS=CONFIG_WRITE(IN_PARAMS,SECTION,'TypeProcess',CAST(TYPE_PROCESS AS VARCHAR(10)));
  IN_PARAMS=CONFIG_WRITE(IN_PARAMS,SECTION,'Locked',LOCKED);

  FOR SELECT SUCCESS
       FROM SEND_EVENT(0,0,:APPLICATION_ID,:ACCOUNT_ID,NULL,:SESSION_ID,:PROTOCOL,:SECTION,:IN_PARAMS)
       INTO :TEMP DO BEGIN
  END
END
...
BEGIN
  ...
  EXECUTE PROCEDURE EVENT_REFRESH_ORDER('A35F5701A7AA920E40812A71A690910D',NULL,SESSION_ID,0,
                                        ORDER_ID,NULL,TYPE_PROCESS,LOCKED);
...
BEGIN
  ...
  IF (LOCKED IS NULL) THEN BEGIN
    ...
    UPDATE ORDERS
     ...
     EXECUTE PROCEDURE EVENT_REFRESH_ORDER('A35F5701A7AA920E40812A71A690910D',NULL,SESSION_ID,0,
                                           OLD_ORDER_ID,NULL,TYPE_PROCESS,LOCKED);
...
BEGIN
  ...
  IF (NEXT_ID IS NOT NULL) THEN BEGIN
    ...
    EXECUTE PROCEDURE CREATE_ORDER_HISTORY(SESSION_ID,OLD_ORDER_ID,NEW_ORDER_ID,ACCOUNT_ID,
                                           NEXT_ID,NULL,TYPE_PROCESS,CURRENT_TIMESTAMP,1,WITH_EVENT);
...
DROP PROCEDURE GET_LOCK_ORDERS
