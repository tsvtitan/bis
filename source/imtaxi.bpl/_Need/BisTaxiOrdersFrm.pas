        ...
        try
          ...
          if Assigned(FParent) and Assigned(FParent.Provider) then begin
            ...
            if not Terminated and FAutoRefresh and Assigned(FParent) and
              ...
              try
                FServer.UseWaitCursor:=false;
                FServer.UseShowError:=false;
                FServer.UseCache:=false;
