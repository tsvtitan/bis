...
public class TaxiMobileClient extends MIDlet implements CommandListener, Runnable, MessageListener {
 ...
 //     cg.append(SCall.toString(),null);
      ...
      FormSetup.append(cg);
      TextField t1=new TextField(SLogin.toString(),Login.toString(),100,TextField.ANY);
      FormSetup.append(t1);
      ...
      try {
        ...
        if (msg!=null) {
          if (msg instanceof TextMessage) {
            ...
            String s="Unknown message";

            PlayMessage();

            Alert a=new Alert(SMessage.toString(),s.toString(),null,AlertType.ERROR);
            a.addCommand(CommandOK);
            a.setCommandListener(this);
            a.setTimeout(AlertTimeOut);
            Display.getDisplay(this).setCurrent(a);
