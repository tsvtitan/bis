...
type
  ...
  TDeviceClasses=set of TDeviceClass;
  ...
  private
    ...
    procedure ScanDevices(var ADeviceList: TDeviceList; DeviceClasses: TDeviceClasses);
  ...
  public
    ...
    procedure GetInfo(DeviceClasses: TDeviceClasses=[dcBattery..dcUSB]);
...
procedure TDevices.GetInfo(DeviceClasses: TDeviceClasses);
begin
  try
    ScanDevices(FDeviceList,DeviceClasses);
    FDeviceList.Sort;
...
procedure TDevices.ScanDevices(var ADeviceList: TDeviceList; DeviceClasses: TDeviceClasses);
                  ...
                  if not IsNT or (IsNT and KeyExists(rkControl)) then begin
                    ...
                    with dr^ do begin
                      ...
                      if (Trim(dr.ClassName)<>'') then begin
                        ...
                        if dr.DeviceClass in DeviceClasses then begin
