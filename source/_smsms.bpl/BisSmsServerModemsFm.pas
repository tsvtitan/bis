...
type
  TBisSmsServerModemsForm = class(TBisDialogForm)
    ButtonSave: TButton;
  ...
  TBisSmsServerModemsFormIface=class(TBisDialogFormIface)
  private
    FShowByCommand: Boolean;
  protected
...
var
  BisSmsServerModemsForm: TBisSmsServerModemsForm;

implementation

{$R *.dfm}

uses BisCoreIntf, BisCore, BisDialogs, BisUtils, BisGsmModem, BisComPort, BisSmsServerConsts,
     BisServerModules, BisServers;

{ TBisSmsServerModemsFormIface }

function TBisSmsServerModemsFormIface.CreateForm: TBisForm;
begin
  Result:=inherited CreateForm;
  if Assigned(Result) then
    TBisSmsServerModemsForm(Result).ShowByCommand:=FShowByCommand;
end;

class function TBisSmsServerModemsFormIface.GetFormClass: TBisFormClass;
begin
  Result:=TBisSmsServerModemsForm;
end;

procedure TBisSmsServerModemsFormIface.ShowByCommand(const Command: string);
begin
  FShowByCommand:=true;
  ShowModal;
end;

{ TBisSmsServerModemsForm }

constructor TBisSmsServerModemsForm.Create(AOwner: TComponent);
var
  Buffer: String;
begin
...
destructor TBisSmsServerModemsForm.Destroy;
begin
  FModems.Free;
  inherited Destroy;
end;

procedure TBisSmsServerModemsForm.Init;
var
  OldIndex: Integer;
begin
  inherited Init;
...
procedure TBisSmsServerModemsForm.FillDefault;
var
  i: Integer;
begin
...
procedure TBisSmsServerModemsForm.LoadFromBase;
var
  i: Integer;
  Server: TBisServer;
...
procedure TBisSmsServerModemsForm.EnableModems(AEnabled: Boolean);
begin
...
procedure TBisSmsServerModemsForm.CheckBoxEnabledClick(Sender: TObject);
begin
...
procedure TBisSmsServerModemsForm.SetModems(Port: String);
begin
...
procedure TBisSmsServerModemsForm.GetModems(Port: String);
begin
  if FModems.Locate('PORT',Port,[loCaseInsensitive]) then begin
...
procedure TBisSmsServerModemsForm.ComboBoxComportChange(Sender: TObject);
begin
...
function TBisSmsServerModemsForm.CheckFields: Boolean;
begin
  Result:=false;
...
procedure TBisSmsServerModemsForm.ButtonOkClick(Sender: TObject);
begin
...
procedure TBisSmsServerModemsForm.ButtonSaveClick(Sender: TObject);
begin
  if CheckFields then
    SaveModems;
end;

procedure TBisSmsServerModemsForm.ButtonTestClick(Sender: TObject);
begin
  if CheckFields then
    TestModem;
end;

procedure TBisSmsServerModemsForm.SetOnlyOneModem(const Value: Boolean);
begin
  FOnlyOneModem:= Value;
...
procedure TBisSmsServerModemsForm.TestModem;
var
  Modem: TBisGsmModem;
  OldCursor: TCursor;
  S: String;
...
procedure TBisSmsServerModemsForm.SaveModems;
var
  i: Integer;
  Server: TBisServer;
  Param: TBisServerParam;
...
procedure TBisSmsServerModemsForm.RestartServer;
var
  i: Integer;
  Server: TBisServer;
begin
