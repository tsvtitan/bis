...
uses DbConsts, DBGrids, Clipbrd{$IFDEF EH_LIB_6}, VDBConsts, Types{$ENDIF};
...
begin
  ...
  if not FKeyTextIndependent then
    if not FListActive then
      ...
      SetEditText(FullListSource.DataSet.FieldByName(FListField.FieldName).DisplayText)
