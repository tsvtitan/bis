...
type
  ...
  private                                                                                              
    ...
    procedure SetViewMode(const Value: TBisCallDataCallViewMode);
  ...
  public
    ...
    property ViewMode: TBisCallDataCallViewMode read FViewMode write SetViewMode;
...
uses DateUtils,
     ...
     BisCallDataCallFilterFm;

{$R *.dfm}

{ TBisCallDataOutMessagesFrame }

constructor TBisCallDataCallsFrame.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
  FilterClass:=TBisCallDataCallFilterFormIface;
...
begin
  ...
  if Assigned(AIface) and (AIface is TBisCallDataCallEditFormIface) then begin
...
procedure TBisCallDataCallsFrame.SetViewMode(const Value: TBisCallDataCallViewMode);
begin
  FViewMode:=Value;
  case FViewMode of
    vmFull: begin
