...
begin
  inherited;
  FParent.DoMessage('TBisSipTransactionDispatcher.OnTerminated');
end;
...
begin
  inherited;
  FParent.DoMessage('TBisSipTransactionDispatcher.OnRejectedMessage'+#13#10+Msg);
end;
...
function TBisSipStack.GetUserAgent: String;
begin
...
procedure TBisSipStack.SetUserAgent(const Value: String);
begin
