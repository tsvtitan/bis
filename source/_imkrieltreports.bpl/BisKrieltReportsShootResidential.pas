...
begin
  ...
  XLSNew:=CopyExcelDocToNew('shoot_datchas_in_point.xls','Сниму_дачи_в_населенном_пункте');
  Excel:=OpenExcelDoc(XLSNew);
  Sheet:=Excel.ActiveSheet;
...
begin
  ...
  XLSNew:=CopyExcelDocToNew('shoot_datchas_out_point.xls','Сниму_дачи_за_населенным_пунктом');
  Excel:=OpenExcelDoc(XLSNew);
  Sheet:=Excel.ActiveSheet;
