...
{ Report }
  ...
  // by TSV
  TfrxGetIniFileEvent=function(var Created: Boolean): TCustomIniFile of object;
  ...
  private
    ...
    FOnGetIniFile: TfrxGetIniFileEvent;
  ...
  protected
    ...
    procedure DefineProperties(Filer: TFiler); override;
    // By TSV
    procedure DoAfterCreateDesigner; virtual;
  ...
  public
    ...
    // by tsv
    function PrepareReport(ClearLastReport: Boolean = True): Boolean; virtual;
    ...
    property OnGetIniFile: TfrxGetIniFileEvent read FOnGetIniFile write FOnGetIniFile; 
  published
    ...
    begin
      ...
      try
        ...
        if ini.OpenKey(DEF_REG_CONNECTIONS, false) then
          FReport.OnSetConnection(ini.ReadString(Value));
      finally
        ini.Free;
      end;
    end;
...
function TfrxReport.GetIniFile(var Created: Boolean): TCustomIniFile;
begin
  // by TVS
  Result:=nil;
  if Assigned(FOnGetIniFile) then
    Result:=FOnGetIniFile(Created);
...
procedure TfrxReport.DoAfterCreateDesigner;
begin
