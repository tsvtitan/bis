...
begin
  ...
  Provider.ProviderName:='_SHOOT_UNRESIDENTIAL_KRS_EXPORT';      
...
begin
  ...
  Provider:=TBisProvider.Create(nil);
  Provider.ProviderName:='_SHOOT_UNRESIDENTIAL_OTHERS_EXPORT';      
  ...
  XLSNew:=CopyExcelDocToNew('shoot_unresidential_others.xls','Сниму_нежилое_в_других_населенных_пунктах');
  Excel:=OpenExcelDoc(XLSNew);
  Sheet:=Excel.ActiveSheet;
