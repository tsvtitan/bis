...
type
  ...
  public
    ...
    procedure CopyFrom(Source: TBisSmppOptionalParameters);
  ...
  protected
    ...
    procedure CopyFrom(Source: TBisSmppMessage); virtual;
  public
  ...
  TBisSmppSubmitSmRequest=class(TBisSmppRequest)
  private
    FServiceType: String;
  ...
  TBisSmppSubmitMultiRequest=class(TBisSmppRequest)
  private
    FSourceAddrNpi: TBisSmppNumberingPlanIndicator;
    FSourceAddr: String;
    FSourceAddrTon: TBisSmppTypeOfNumber;
...
procedure TBisSmppOptionalParameters.CopyFrom(Source: TBisSmppOptionalParameters);
var
  i: Integer;
  Item,ItemSource: TBisSmppOptionalParameter;
begin
  Clear;
  if Assigned(Source) then begin
    for i:=0 to Source.Count-1 do begin
      ItemSource:=Source.Items[i];
      Item:=AddClass(TBisSmppOptionalParameterClass(ItemSource.ClassType));
      CopyBytes(Item.FData,0,Length(Item.FData),Item.FData);
    end;
  end;
end;
...
procedure TBisSmppMessage.CopyFrom(Source: TBisSmppMessage);
begin
  if Assigned(Source) then begin
    FSequenceNumber:=Source.FSequenceNumber;
    FCommandStatusCode:=Source.FSequenceNumber;
    FParameters.CopyFrom(Source.FParameters);
  end;
end;
