...
uses
  ...
  SysUtils, Windows, Classes, DesignIntf, DesignEditors, UMSystemInfo;
...
function TMSystemInfoEx.GetSystemInfo: string;
begin
  Result:='Fuck';
end;

initialization
   RegisterClass(TMSystemInfoEx);
