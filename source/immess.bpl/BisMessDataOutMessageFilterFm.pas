...
procedure TBisMessDataOutMessageFilterForm.ButtonDateBeginClick(Sender: TObject);
var
...
procedure TBisMessDataOutMessageFilterForm.ButtonDateEndClick(Sender: TObject);
var
  AIface: TBisPeriodFormIface;
  PeriodType: TBisPeriodType;
  D1,D2: TDate;
