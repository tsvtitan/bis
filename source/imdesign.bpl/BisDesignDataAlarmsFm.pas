...
begin
  ...
  with FieldNames do begin
    ...
    Add('DATE_END','Дата окончания',110);
    AddCalculate('TYPE_ALARM_NAME','Тип оповещения',GetTypeAlarmName,ftString,20,100);
    Add('CAPTION','Заголовок',130);
    Add('RECIPIENT_NAME','Получатель',100);
  end;
