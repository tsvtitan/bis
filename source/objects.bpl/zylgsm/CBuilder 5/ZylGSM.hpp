...
// (DO NOT EDIT: machine generated header) 'ZylGSM.pas' rev: 5.00
...
enum TCommPort { spNone, spCOM1, spCOM2, spCOM3, spCOM4, spCOM5, spCOM6, spCOM7, spCOM8, spCOM9, spCOM10, 
	...
	spCOM249, spCOM250, spCOM251, spCOM252, spCOM253, spCOM254, spCOM255 };
#pragma option pop
...
typedef void __fastcall (__closure *TNewMessageEvent)(System::TObject* Sender, AnsiString Location, 
	int Index);

typedef void __fastcall (__closure *TReadMessageEvent)(System::TObject* Sender, AnsiString MessageText
	, AnsiString PhoneNumber, AnsiString CenterNumber, int Status);

typedef void __fastcall (__closure *TDetectEvent)(System::TObject* Sender, const TCommPort Port, const 
	TBaudRate BaudRate, bool &Cancel);
...
private:
	...
	AnsiString __fastcall SafeCopy(const AnsiString strText, int nStart, int nLength, const AnsiString 
		DefaultValue);
...
public:
	...
	bool __fastcall DetectGSM(const TBaudRate startBaudRate, const TBaudRate endBaudRate, TCommPort &pPort
		, TBaudRate &pBaudRate)/* overload */;
