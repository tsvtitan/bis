...
type
  ...
  private
    ...
    function GetOnUses: TUsesEvent;
    procedure SetOnUses(const Value: TUsesEvent);
  protected
  ...
  published
    ...
    // by TSV
    property OnUses: TUsesEvent read GetOnUses write SetOnUses;
...
procedure TDelphiWebScriptII.SetOnUses(const Value: TUsesEvent);
begin
  Config.OnUses:=Value;
end;

function TDelphiWebScriptII.GetOnUses: TUsesEvent;
begin
  Result:=Config.OnUses;
end;
