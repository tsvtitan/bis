...
CREATE OR REPLACE PROCEDURE /*PREFIX*/I_APPLICATION_MENU
(
...
CREATE OR REPLACE PROCEDURE /*PREFIX*/U_APPLICATION_MENU
(
  APPLICATION_ID IN VARCHAR2,
  MENU_ID IN VARCHAR2,
...
BEGIN
  UPDATE /*PREFIX*/APPLICATION_MENUS
     SET APPLICATION_ID=U_APPLICATION_MENU.APPLICATION_ID,
         MENU_ID=U_APPLICATION_MENU.MENU_ID
...
CREATE OR REPLACE PROCEDURE /*PREFIX*/D_APPLICATION_MENU
(
  OLD_APPLICATION_ID IN VARCHAR2,
  OLD_MENU_ID IN VARCHAR2
)
