...
uses
  ...
  BisDataGridFm, BisDocproHbookDocsFrm, BisDataFrm;
...
begin
  ...
  with FieldNames do begin
    ...
    Add('NUM','Номер',60);
    Add('DATE_DOC','Дата документа',75);
...
class function TBisDocproHbookDocsForm.GetDataFrameClass: TBisDataFrameClass;
begin
  Result:=TBisDocproHbookDocsFrame;
end;
